...
Begin VB.Form casher_closefrm 
   ...
   Begin VB.CommandButton cmdSave 
      ...
      Left            =   2340
      MaskColor       =   &H00FFFFFF&
      Picture         =   "casher_close2.frx":0000
      RightToLeft     =   -1  'True
      Style           =   1  'Graphical
      TabIndex        =   13
      TabStop         =   0   'False
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton CmdExit 
         ...
         Left            =   45
         MaskColor       =   &H00FFFFFF&
         Picture         =   "casher_close2.frx":2363
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   4
         TabStop         =   0   'False
...
cString = "SELECT SUM(AMOUNT * RATE) as sumofAmount FROM CASHER_CLOSE"
cString = cString & turn(cString) & "DATE = " & DateSq(dSalesDate)
cString = cString & turn(cString) & "BOX = " & MyParn(sboxSales)
xBalance.Caption = Round(Val(GetField(cString) & ""), 2)

cField = myiif("FLAG = 1", "AMOUNT") & " AS Cash"
...
xDate.Caption = Format(dSalesDate, "YYYY-MM-DD")
...
Next
For I = 1 To grid1.Rows - 1
    grid1.TextMatrix(I, 2) = Round(Val(.TextMatrix(I, 0)) - Val(.TextMatrix(I, 1)), 2)
    grid1.TextMatrix(I, 4) = Round(Val(.TextMatrix(I, 2)) - Val(.TextMatrix(I, 3)), 2)
