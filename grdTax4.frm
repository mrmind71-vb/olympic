...
Begin VB.Form grdTax4 
   Caption         =   "⁄‰Ê«‰Ì‰ «·«⁄÷«¡ «·„ Œ·›Ì‰ ⁄‰ ”œ«œ «·ﬁÌ„… «·„÷«›… ··«ﬁ”«ÿ"
   ClientHeight    =   10110
   ClientLeft      =   90
   ClientTop       =   465
   ClientWidth     =   20250
   ...
   Begin VB.Frame Frame2 
      ...
      Begin Threed.SSCommand cmdPrintLand 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "grdTax4.frx":9647
         Caption         =   "ÿ»«⁄…"
         ButtonStyle     =   1
         PictureAlignment=   10
         BevelWidth      =   0
         PictureDisabledFrames=   1
         PictureDisabled =   "grdTax4.frx":C645
      End
   End
...
ToFileExel2 grid1, , , , , 1, , , aSplit, , , Me, myHeader
End Sub
...
cString = "SELECT '',FILE1_10.CODE, FILE1_10.DESCA,FILE1_10.ADDRESS,SUM(FILE1_60.TOTAL)" & _
           " FROM FILE1_60 INNER JOIN  FILE1_10 ON FILE1_60.MEMBER = FILE1_10.CODE"
           
If Option1(1).Value Then
    cWhere = "NOT (ADDRESS IS NULL)"
    aHeader(0) = Option1(1).Caption
ElseIf Option1(2).Value Then
    cWhere = " (ADDRESS IS NULL)"
    aHeader(0) = Option1(2).Caption
End If

cWhere = cWhere & turn(cWhere, " and ") & "[dbo].[fn_Member_must_admin](file1_10.code) = 1"

If ValidNum(xcode.Text) Then
    cWhere = cWhere & turn(cWhere, " and ") & "FILE1_60.[MEMBER]  = " & addvalue(xcode.Text)
    aHeader(1) = "⁄÷ÊÌ… —ﬁ„ : " & xcode.Text
End If
...
cString = cString & " GROUP BY FILE1_10.CODE, FILE1_10.DESCA,FILE1_10.ADDRESS"
...
Dim nTotal_Sales As Double, nTotal_in As Double
    ...
    For i = 0 To .Cols - 1
        ...
        If i >= 4 Then
            .Subtotal flexSTSum, -1, i, IIf(bPrint, "#0", "#0.00"), &HC0FFC0, vbBlack, True, "  "
...
For i = 2 To grid1.rows - 1
    temptable.AddNew
    temptable!val1 = Val(grid1.TextMatrix(i, 1))
    temptable!str1 = TurnValue(ArbString(grid1.TextMatrix(i, 1)))
    temptable!str2 = TurnValue(ArbString(grid1.TextMatrix(i, 2)))
    temptable!memo1 = ArbString("»«·«‘«—… «·Ì «·Œÿ«» «·Ê«—œ „‰ «·ÃÂ… «·«œ«—Ì… »‘«‰  ÿ»Ìﬁ „« Ã«¡ »«·ﬁ«‰Ê‰ 67 ·”‰… 2016 » Õ’Ì· ›—ﬁ ÷—Ì»… «·ﬁÌ„… «·„÷«›… ⁄‰ «·⁄÷ÊÌ«  «·ÃœÌœ… «· Ì  „ ﬁ»Ê·Â« »√À— —Ã⁄Ì „‰– 2016/9/8 ÊÕ Ì  «—ÌŒÂ ° Ê»‰«¡ ⁄·Ì „Ê«›ﬁ… „Ã·” «·«œ«—… »Ã·” Â —ﬁ„ (11) «„ œ«œ —«»⁄ » «—ÌŒ 2021/6/19 ›«‰Â Ì” Õﬁ ⁄·Ì ”Ì«œ ﬂ„ „»·€")
    temptable!memo1 = ArbString(temptable!memo1 & " " & mRound(grid1.TextMatrix(i, 4), 0) & "(" & MyOnly(mRound(grid1.TextMatrix(i, 4), 0)) & ")")
    temptable!memo1 = ArbString(temptable!memo1 & " " & " ﬁÌ„… 14% ÷—Ì»… «·ﬁÌ„… «·„÷«›… «·„” Õﬁ… ⁄·Ï ⁄÷ÊÌ… ”Ì«œ ﬂ„  ÿ»Ìﬁ« ··ﬁ«‰Ê‰ ”«·› «·–ﬂ—.")
    'temptable!Str3 = ArbString("Ê–·ﬂ ÿ»ﬁ« ··—»ÿ «·–Ì  „ „‰ „’·Õ… «·÷—«∆» ⁄·Ì «·÷—Ì»… «·„” Õﬁ…  ⁄·Ì «·«ﬁ”«ÿ «⁄ »«—« „‰ ” „»— 2016 ")
    'temptable!Str4 = ArbString("ÊÂÏ ﬁÌ„… ÷—Ì»… «·ﬁÌ„… «·„÷«›… «·„” Õﬁ… ⁄·Ì «ﬁ”«ÿ «·⁄÷ÊÌ… „‰ " & myFormat_p(DATE_TAX1) & vbCrLf & " Õ Ì " & myFormat_p(DATE_TAX2))
    temptable!str6 = TurnValue(ArbString(grid1.TextMatrix(i, 3)))
    temptable.Update
Next
...
Else
    contemp.BeginTrans
    contemp.CommitTrans
    Report1.ReportFileName = sPath_App & "\REPORTS\warrent_tax.rpt"
