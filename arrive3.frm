   ...
   Begin VB.Frame Frame8 
      ...
      Begin Threed.SSCommand cmdLast 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "arrive3.frx":1073D
         Caption         =   "«ŒÌ—"
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "arrive3.frx":1290D
      End
      Begin Threed.SSCommand cmdNext 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "arrive3.frx":14A55
         Caption         =   "·«Õﬁ "
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "arrive3.frx":16C1D
      End
      Begin Threed.SSCommand cmdPrevious 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "arrive3.frx":18D6C
         Caption         =   "”«»ﬁ"
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "arrive3.frx":1AF4C
      End
      Begin Threed.SSCommand cmdFirst 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "arrive3.frx":1D0A7
         Caption         =   "√Ê·"
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "arrive3.frx":1F263
      End
   End
...
PrintGrdNew.doprint grid1, 0.75, -3, cHeader1, , , , False, False, 10
PrintGrdNew.Show 1
MyAddItem
End Sub
...
Dim loctable As New ADODB.Recordset, nRowAdd As Long, nRow As Long
...
cString = "select code,desca,Salary  from driver where salary_code = 1"
...
If grid1.TextMatrix(Row, 1) <> "" And grid1.TextMatrix(Row, grid1.Cols - 1) <> "" Then
    salary_paid.sDoc_no = xDoc_No.Text
    salary_paid.SCODE = grid1.TextMatrix(Row, 1)
    salary_paid.Show 1
    myloadgrd
End If
End Sub
...
If (grid1.Col = 1 Or grid1.Col = 4 Or grid1.Col = 6 Or grid1.Col = 7 Or grid1.Col = 8 Or grid1.Col = 10 Or grid1.Col = 12) Then
...
XBOX.BoundText = ""
xWeek.Text = "1"
xcharge.Text = GetField("SELECT CHARGE FROM FILE2_50H WHERE (NOT CHARGE IS NULL) AND TYPE = 1 ORDER BY DOC_NO DESC") & ""
...
If Col = 1 Then
    ...
    Else
        ...
        Else
'            grid1.EditText = RetZero(grid1.EditText)
            aRet = GetFields("select * from driver where SALARY_CODE = 1 and code = " & MyParn(grid1.EditText), con)
...
ElseIf KeyCode = 112 Then
    DriverLookupAll Me, oSearchEmp, "SALARY_CODE = 1"
...
For I = 1 To grid1.Rows - 2
    ...
    grid1.TextMatrix(I, 9) = Val(grid1.TextMatrix(I, 5)) + Val(grid1.TextMatrix(I, 6)) - Val(grid1.TextMatrix(I, 7)) - Val(grid1.TextMatrix(I, 8))
    grid1.TextMatrix(I, 11) = Val(grid1.TextMatrix(I, 9)) - Val(grid1.TextMatrix(I, 10))
...
.FormatString = "„|" & "ﬂÊœ|" & "«·«”„|" & "«·ÌÊ„Ì…|" & "«Ì«„ «·Õ÷Ê—|" & "«·„— »|" & "«÷«›Ì|" & "Ã“«¡« |" & "”·›|" & "«·«Ã„«·Ì|" & "„”œœ|" & "»«ﬁÌ|" & "„·«ÕŸ« |"
.ColWidth(0) = 600
.ColWidth(1) = 1100
.ColWidth(2) = 2500
.ColWidth(3) = 1000
...
With grid1
    For I = IIf(Row = -1, 1, Row) To IIf(Row = -1, grid1.Rows - 2, Row)
        ...
        aInsert = AddFlag(aInsert, "DEBIT", Val(grid1.TextMatrix(I, 8)))
        aInsert = AddFlag(aInsert, "NOTES", addstring(grid1.TextMatrix(I, 12)))
...
With grid1
    cString = "SELECT FILE2_50.CODE,DRIVER.DESCA,FILE2_50.SALARY, FILE2_50.DAYS,FILE2_50.SALARY_TOTAL,FILE2_50.PLUS,FILE2_50.MINUS,FILE2_50.DEBIT,FILE2_50.TOTAL,SALARY_BALANCE.PAID,SALARY_BALANCE.BALANCE,FILE2_50.NOTES,FILE2_50.ID" & _
              " FROM FILE2_50 inner JOIN DRIVER ON FILE2_50.CODE = DRIVER.CODE LEFT JOIN SALARY_BALANCE ON (FILE2_50.DOC_NO = SALARY_BALANCE.DOC_NO AND FILE2_50.CODE = SALARY_BALANCE.CODE) WHERE FILE2_50.DOC_NO = " & MyParn(xDoc_No.Text)
...
cString = "SELECT * FROM FILE2_50H WHERE TYPE = 1"
...
If Col < grid1.Cols - 2 Then
    If Col < 6 Then
        grid1.Col = 6
    Else
        grid1.Col = Col + 1 + IIf(Col = 4, 1, 0) + IIf(Col = 8, 3, 0)
    End If
ElseIf Row < grid1.Rows - 1 Then
    grid1.Select Row + 1, NextEmpty(grid1, Row + 1, 1, 6)
...
sDoc_no = GetField("Select doc_no from FILE2_50H where [YEAR] = " & xYear.Text & _
          " and [Month] = " & xMonth.Text & " AND WEEK = " & xWeek.Text & " AND TYPE = 1")
