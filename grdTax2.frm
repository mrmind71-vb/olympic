   ...
   Begin VB.Frame Frame2 
      ...
      Begin Threed.SSCommand cmdPrintLand 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "grdTax2.frx":7149
         Caption         =   "ØÈÇÚÉ"
         ButtonStyle     =   1
         PictureAlignment=   10
         BevelWidth      =   0
         PictureDisabledFrames=   1
         PictureDisabled =   "grdTax2.frx":A147
      End
   End
...
cString = "SELECT '',FILE1_10.CODE, FILE1_10.DESCA,SUM(FILE1_60.VALUE),SUM(FILE1_60.TAX),SUM(FILE1_60.TAX_LATE),SUM(FILE1_60.TOTAL)" & _
...
cString = cString & " GROUP BY FILE1_10.CODE, FILE1_10.DESCA"
...
Dim nTotal_Sales As Double, nTotal_in As Double
    ...
    .TextMatrix(0, 3) = "ÅÌãÇáí ÇáÞÓØ"
    .TextMatrix(0, 4) = "ÅÌãÇáí ÇáÖÑíÈÉ"
    .TextMatrix(0, 5) = "ÅÌãÇáí ÇáÛÑÇãÇÊ"
    .TextMatrix(0, 6) = "ÅÌãÇáí ÇáãÓÊÍÞ"
