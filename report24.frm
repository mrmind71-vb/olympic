...
Dim aHeader(11)
cString = "Select file1_10.CODE ,FILE1_10.DESCA,FILE1_10.DATE_BEGIN,FILE1_10.CODE_MAIN,FILE1_10.SES_NO,FILE6_20H.DOC_NO,FILE6_20H.DATE  " & _
          " From File1_10 " & _
          " inner join file6_20h on file6_20h.code = file1_10.code"

cWhere = "(not FILE6_20H.FORM_NO IS NULL)"
cWhere = cWhere & turn(cWhere, " and ") & "FILE6_20H.DOC_NO = dbo.f_first_year_doc(FILE1_10.CODE) and FILE6_20H.TYPE = 7"


If ValidNum(xcode1.text) Then
    cWhere = cWhere & turn(cWhere, " AND ") & " FILE1_10.code " & IIf(ValidNum(xCode2.text), " >= ", " = ") & addvalue(xcode1.text)
    aHeader(0) = IIf(ValidNum(xCode2.text), BetweenString(xcode1.text, xCode2.text, "„‰ —ﬁ„ ⁄÷ÊÌ… : ", "Õ Ì —ﬁ„ ⁄÷ÊÌ… : "), "—ﬁ„ ⁄÷ÊÌ… :" & xcode1.text)
End If

If ValidNum(xCode2.text) Then
    cWhere = cWhere & turn(cWhere, " AND ") & " FILE1_10.code <= " & addvalue(xCode2.text)
    aHeader(0) = BetweenString(xcode1.text, xCode2.text, "„‰ —ﬁ„ ⁄÷ÊÌ… : ", "Õ Ì —ﬁ„ ⁄÷ÊÌ… : ")
End If

If IsNumeric(cmdYear(0).Tag) Then
    aHeader(1) = "«·–Ì‰ ›’·Ê« „Ê”„ " & cmdYear(0).Caption
    cWhere = cWhere & turn(cWhere, " and ") & "dbo.f_first_year_code(FILE1_10.CODE) = " & cmdYear(0).Tag
End If
...
Do Until sourcetable.EOF
    ...
    temptable!str5 = TurnValue(ArbString(sourcetable!code_main & ""))
    temptable!str6 = TurnValue(ArbString(myFormat_p(sourcetable!Date)))
    temptable!str7 = TurnValue(ArbString(sourcetable!doc_no))
...
Else
    ...
    Report1.ReportFileName = sPath_App & "\REPORTS\REPORT24.rpt"
