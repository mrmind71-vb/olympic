...
Begin VB.Form cardqryChairfrm 
   ...
   Begin VSFlex7Ctl.VSFlexGrid grid1 
      Bindings        =   "cardqrychair.frx":E411
      Height          =   6090
      Left            =   0
      TabIndex        =   34
      Top             =   2025
   ...
   End
End
Attribute VB_Name = "cardqrychairfrm"
...
If Col = 5 Then
    If grid1.TextMatrix(Row, 1) = "" Then
        cString = "Update file1_10 set " & _
                  "file1_10.chair_desca = " & addstring(grid1.TextMatrix(Row, 5)) & _
                  " where file1_10.code = " & addvalue(grid1.TextMatrix(Row, 0))
    Else
        cString = "Update file1_11 set " & _
                  "file1_11.chair_desca = " & addstring(grid1.TextMatrix(Row, 5)) & _
                  " where file1_11.id = " & addvalue(grid1.TextMatrix(Row, 6))
    End If
...
grid1.Editable = IIf(grid1.Col = grid1.Cols - 1 Or grid1.Col = 5, flexEDKbdMouse, flexEDNone)
End Sub
...
SettingArray(cRightMargin) = MyMeasure(-1.4) + MyMeasure(0.2)
...
For I = 1 To grid1.rows - 1
    If validPhoto(RetPhoto(grid1.TextMatrix(I, 2))) And (Val(grid1.TextMatrix(I, grid1.Cols - 1)) <> 0) Then
        ...
        For i2 = 1 To 1
            ...
            tCard!Top = MyMeasure(0.3) + MyMeasure(nDiffer * 1)
            ...
            tCard!Top = MyMeasure(0.3) + MyMeasure(nDiffer * 2) + MyMeasure(0.4)
            ...
            tCard!ForeColor = vbBlack
            tCard!FontSize = 11
            tCard!text = ArbString(grid1.TextMatrix(I, 4) & turn(grid1.TextMatrix(I, 4), " : ") & grid1.TextMatrix(I, 3))
            tCard!CardNo = nCard
            tCard.Update
            ...
            tCard.AddNew
            tCard!Right = MyMeasure(1.2) + MyMeasure(1.2)
            tCard!Top = MyMeasure(0.2) + MyMeasure(nDiffer * 4) + MyMeasure(0.3)
            tCard!Width = 0
            tCard!Height = 0
            tCard!FontName = "Arial"
            tCard!FontBold = True
...
For I = 1 To grid1.rows - 1
    ...
    Else
        grid1.Cell(flexcpForeColor, I, 0, I, .Cols - 1) = &H80000008
    End If
Next
prog1.Visible = False
End With
...
Dim nRecordcount As Long, I As Double, bAddRow As Boolean
Me.MousePointer = 11
...
If ValidInt(xCode1.text) Then
    cWhere = cWhere & turn(cWhere, " and ") & " File1_10.CODE  " & IIf(IsNumeric(xCode2.text), " >= ", " = ") & xCode1.text
End If

If ValidInt(xCode2.text) Then
    cWhere = cWhere & turn(cWhere, " and ") & " File1_10.CODE <= " & xCode2.text
End If

If chkChair.Value = 1 Then
    cWhere = cWhere & turn(cWhere, " and ") & "(not file1_10.chair_desca is Null)"
End If
...
Do Until loctable.EOF
    I = I + 1
    prog1.Value = mRound(I / (nRecordcount), 2) * 100
    If .FindRow(loctable!CODE, , 0) = -1 Then
        ...
        .TextMatrix(grid1.rows - 1, 4) = loctable!Title & ""
        .TextMatrix(grid1.rows - 1, 5) = loctable!Chair_desca & ""
...
cString = "SELECT file1_11.Code,File1_11.Member,File1_11.Title,file1_11.descA,file1_11.chair_desca,file1_11.id " & _
        " From File1_11 Inner Join File1_10 On File1_11.Member = File1_10.Code  " & _
        " WHERE FILE1_11.RELATION =  1"
...
If chkChair.Value = 1 Then
    cWhere = cWhere & turn(cWhere, " and ") & "(not file1_11.chair_desca is Null)"
End If

If cWhere <> "" Then cString = cString & " AND " & cWhere

If ValidNum(xAppend.text) Or chkChair.Value = 1 Then
    Set loctable = New ADODB.Recordset
    loctable.Open cString, con, adOpenStatic, adLockReadOnly, adCmdText
    If Not (loctable.EOF And loctable.BOF) Then
        nRecordcount = loctable.RecordCount
    ...
    Do Until loctable.EOF
        ...
        If .FindRow(loctable!MEMBER & "-" & loctable!CODE, , 2) = -1 Then
            ...
            .TextMatrix(.rows - 1, 4) = loctable!Title & ""
            .TextMatrix(.rows - 1, 5) = loctable!Chair_desca & ""
            .TextMatrix(.rows - 1, 6) = loctable!ID
            .TextMatrix(grid1.rows - 1, .Cols - 1) = 1
        End If
        loctable.MoveNext
    Loop
