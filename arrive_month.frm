   ...
   Begin VB.Frame Frame8 
      ...
      Begin Threed.SSCommand cmdLast 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "arrive_month.frx":1073D
         Caption         =   "«ŒÌ—"
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "arrive_month.frx":1290D
      End
      Begin Threed.SSCommand cmdNext 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "arrive_month.frx":14A55
         Caption         =   "·«Õﬁ "
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "arrive_month.frx":16C1D
      End
      Begin Threed.SSCommand cmdPrevious 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "arrive_month.frx":18D6C
         Caption         =   "”«»ﬁ"
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "arrive_month.frx":1AF4C
      End
      Begin Threed.SSCommand cmdFirst 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "arrive_month.frx":1D0A7
         Caption         =   "√Ê·"
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "arrive_month.frx":1F263
      End
   End
...
If ActiveControl.Name = grid1.Name Then
    ...
    grid1.TextMatrix(grid1.Row, 3) = oSearchEmp.grid1.TextMatrix(oSearchEmp.grid1.Row, 3)
    grid1.TextMatrix(grid1.Row, 4) = "1"
    grid1.TextMatrix(grid1.Row, 5) = oSearchEmp.grid1.TextMatrix(oSearchEmp.grid1.Row, 3)
...
'            grid1.EditText = RetZero(grid1.EditText)
            ...
            Else
                ...
                grid1.TextMatrix(Row, 5) = retFlag(aRet, "salary") & ""
            End If
        End If
    End If
End If
...
With grid1
    cString = "SELECT FILE2_50.CODE,DRIVER.DESCA,FILE2_50.SALARY, FILE2_50.DAYS,FILE2_50.SALARY_TOTAL,FILE2_50.PLUS,FILE2_50.MINUS,FILE2_50.TOTAL,FILE2_50.NOTES,FILE2_50.ID" & _
              " FROM FILE2_50 inner JOIN DRIVER ON FILE2_50.CODE = DRIVER.CODE WHERE FILE2_50.DOC_NO = " & MyParn(xdoc_no.Text)
...
Private Sub xWeek_GotFocus()
myGotFocus xWeek
End Sub
Private Sub xWeek_LostFocus()
myLostFocus xWeek
End Sub
