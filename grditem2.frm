...
Sub FixGrid()
    ...
    .TextMatrix(0, 6) = "—’Ìœ" & Format(xDate1.Text, "YYYY-MM-DD")
    .TextMatrix(0, 7) = "„‘ —Ì« "
    .TextMatrix(0, 8) = "’«œ—"
    .TextMatrix(0, 9) = "Ê«—œ"
    .TextMatrix(0, 10) = "Â«·ﬂ"
    .TextMatrix(0, 11) = " ”ÊÌ… Ã—œ"
    .TextMatrix(0, 12) = "—’Ìœ " & Format(xDate2.Text, "YYYY-MM-DD")
