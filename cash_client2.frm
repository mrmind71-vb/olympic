...
Begin VB.Form cash_client2 
   ...
   Begin VB.Frame Frame8 
      ...
      Begin Threed.SSCommand cmdLast 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "cash_client2.frx":48DC
         Caption         =   "«ŒÌ—"
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "cash_client2.frx":6AAC
      End
      Begin Threed.SSCommand cmdNext 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "cash_client2.frx":8BF4
         Caption         =   "·«Õﬁ "
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "cash_client2.frx":ADBC
      End
      Begin Threed.SSCommand cmdPrevious 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "cash_client2.frx":CF0B
         Caption         =   "”«»ﬁ"
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "cash_client2.frx":F0EB
      End
      Begin Threed.SSCommand cmdFirst 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "cash_client2.frx":11246
         Caption         =   "√Ê·"
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "cash_client2.frx":13402
      End
   End
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton CmdExit 
         ...
         Left            =   45
         MaskColor       =   &H00FFFFFF&
         Picture         =   "cash_client2.frx":15551
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   8
         TabStop         =   0   'False
      ...
      Begin VB.CommandButton CmdDelInv 
         ...
         Left            =   1395
         MaskColor       =   &H00FFFFFF&
         Picture         =   "cash_client2.frx":1796F
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   7
         TabStop         =   0   'False
      ...
      Begin VB.CommandButton cmdNewInv 
         ...
         Left            =   2775
         MaskColor       =   &H00FFFFFF&
         Picture         =   "cash_client2.frx":1A209
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   6
         TabStop         =   0   'False
      ...
      Begin VB.CommandButton CmdInform 
         Height          =   510
         Left            =   4140
         Picture         =   "cash_client2.frx":1C7B5
         Style           =   1  'Graphical
         TabIndex        =   5
         TabStop         =   0   'False
         Top             =   135
   ...
   End
End
Attribute VB_Name = "cash_client2"
...
bEdit = True
openCon con
cStrBox = StrList("Select code,desca from file0_50 where code > '500000'")
cFile = "File8_30"
...
ElseIf Row < grid1.Rows - 1 Then
    Dim nCol As Long
    nCol = NextEmpty(grid1, Row + 1, 0, 4)
    grid1.Select Row + 1, IIf(nCol > 1, 4, nCol)
