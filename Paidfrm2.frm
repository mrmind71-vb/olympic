...
Begin VB.Form paidfrm 
   ...
   Begin VB.Frame Frame6 
      ...
      Top             =   -45
      Width           =   6495
      Begin Threed.SSCommand cmdLateTax 
         Height          =   510
         Left            =   4995
         TabIndex        =   80
         Top             =   180
         ...
         ShapeSize       =   1
      End
      Begin Threed.SSCommand cmdLateTaxInstall 
         Height          =   510
         Left            =   2970
         TabIndex        =   81
         Top             =   180
         ...
         ShapeSize       =   1
      End
      Begin Threed.SSCommand cmdTaxIntsallDtl 
         Height          =   510
         Left            =   45
         TabIndex        =   82
         Top             =   180
   ...
   Begin VB.Frame Frame4 
      ...
      Top             =   8055
      Width           =   3525
      Begin VB.OptionButton optFawry 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin Threed.SSCommand cmdInform 
         ...
         ShapeSize       =   1
         PictureDisabled =   "Paidfrm2.frx":23CB
      End
      Begin Threed.SSCommand cmdNewInv 
         ...
         PictureDisabledFrames=   1
         ShapeSize       =   1
         PictureDisabled =   "Paidfrm2.frx":647C
      End
      Begin Threed.SSCommand cmddel 
         ...
         PictureDisabledFrames=   1
         ShapeSize       =   1
         PictureDisabled =   "Paidfrm2.frx":ABCF
      End
      ...
      Begin Threed.SSCommand cmdPrint 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "Paidfrm2.frx":F386
         ButtonStyle     =   3
         PictureAlignment=   11
         BevelWidth      =   0
         PictureDisabledFrames=   1
         PictureDisabled =   "Paidfrm2.frx":116FC
      End
   End
   Begin VB.Frame Frame2 
      ...
      Top             =   675
      Width           =   12795
      Begin VB.CheckBox xDate_change 
         Alignment       =   1  'Right Justify
         Appearance      =   0  'Flat
         BackColor       =   &H80000005&
         ForeColor       =   &H80000008&
      ...
      Begin Threed.SSCommand cmdData 
         ...
         PictureDisabledFrames=   1
         ShapeSize       =   1
         PictureDisabled =   "Paidfrm2.frx":1387F
      End
   ...
   Begin VB.Frame FRAME_CUR 
      ...
      Begin Threed.SSCommand cmdSave 
         ...
         PictureDisabledFrames=   1
         ShapeSize       =   1
         PictureDisabled =   "Paidfrm2.frx":18491
      End
      Begin Threed.SSCommand cmdUndo 
         ...
         PictureDisabledFrames=   1
         ShapeSize       =   1
         PictureDisabled =   "Paidfrm2.frx":1CE45
      End
   End
   ...
   Begin VB.Frame Frame3 
      ...
      Begin Threed.SSCommand cmdFirst 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "Paidfrm2.frx":1F132
         Caption         =   "√Ê·"
         ButtonStyle     =   3
         PictureAlignment=   10
         BevelWidth      =   0
         PictureDisabledFrames=   1
         PictureDisabled =   "Paidfrm2.frx":212D9
      End
      Begin Threed.SSCommand cmdPrevious 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "Paidfrm2.frx":23320
         Caption         =   "”«»ﬁ"
         ButtonStyle     =   3
         PictureAlignment=   10
         BevelWidth      =   0
         PictureDisabledFrames=   1
         PictureDisabled =   "Paidfrm2.frx":2540B
      End
      Begin Threed.SSCommand cmdNext 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "Paidfrm2.frx":27405
         Caption         =   "·«Õﬁ"
         ButtonStyle     =   3
         PictureAlignment=   9
         BevelWidth      =   0
         PictureDisabledFrames=   1
         PictureDisabled =   "Paidfrm2.frx":29516
      End
      Begin Threed.SSCommand cmdLast 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "Paidfrm2.frx":2B510
         Caption         =   "√ŒÌ—"
         ButtonStyle     =   3
         PictureAlignment=   9
         BevelWidth      =   0
         PictureDisabledFrames=   1
         PictureDisabled =   "Paidfrm2.frx":2D734
      End
   End
   ...
   Begin VB.Frame Frame5 
      ...
      Top             =   7470
      Width           =   1950
      Begin Threed.SSCommand cmdTotal 
         Height          =   825
         Left            =   45
         TabIndex        =   78
         Top             =   180
   ...
   Begin VB.Frame FRAME10 
      ...
      End
   End
   Begin Threed.SSCommand cmdAddItemsOther 
      Height          =   420
      Left            =   3600
      TabIndex        =   84
      Top             =   7560
...
aInsert = AddFlag(aInsert, "[RENEW]", xRenew.Value)
...
If xdoc_no.Tag = DefineMode Then
    ...
    aInsert = AddFlag(aInsert, "[DATE_ISSUE]", addDate(xDate.text))
...
End If
myreplaceGrd Row
con.Execute fixClaim(xdoc_no.text)
'con.Execute fixMemberPaid(xCode.Text)
con.CommitTrans
myreplace = True
Exit Function
myerror:
...
ElseIf ActiveControl.Name = cmdAddItems.Name Then
    myAdditems oSearchItems.grid1.TextMatrix(oSearchItems.grid1.Row, 0)
    Unload oSearchItems
...
If myField("select type from paid_types where code = " & MyParn(xType.BoundText), "type", con) = 300 Then
    ItemsLookupAll Me, oSearchItems, "[OPTIONAL] = 1"
Else
    myAdditems
End If

End Sub
Private Function myAdditems(Optional pItem As String = "") As Boolean
...
If Not IsEmpty(aRet) Then
    ...
    If retFlag(Claim_Type_Load(xType.BoundText, , con), "type") <> 300 Then
        xdoc_no.text = aRet
        xDoc_No_LostFocus
        Exit Function
    End If
...
Dim aSql As Variant
aRet = addPayment(xCode.text, myFormat(xDate.text), xType.BoundText, con, , , , bFawry, xRenew.Value = 1, True, pItem)
If IsEmpty(retFlag(aRet, "error")) Then
    If Not IsEmpty(retFlag(aRet, "msg")) Then
        MsgBox retFlag(aRet, "msg")
    End If
    
    If Not IsEmpty(retFlag(aRet, "msg2")) Then
        MsgBox retFlag(aRet, "msg2")
    End If
    ...
    If Not IsEmpty(aSql) Then
        ...
        prog1.Visible = False
        If bFawry Then
            If ApplyFawry(retFlag(aRet, "doc_no")) Then
                con.Execute "update file6_20h set file6_20h.form_no = " & Newflag("file6_20h", "form_no", con, "FILE6_20H.ISFAWRY = 1") & " where doc_no = " & addvalue(retFlag(aRet, "doc_no"))
                con.Execute fixMemberPaid(xCode.text)
            End If
        End If
        con.CommitTrans
...
Private Sub cmdAddItemsOther_Click()
Dim sCodeSave As String
sCodeSave = xCode.text
mydefine
xType.BoundText = cmdAddItemsOther.Tag
xCode.text = sCodeSave
myAdditems
End Sub
...
cString = "SELECT TOP 2000 FILE6_20H.DOC_NO, FILE6_20H.FORM_NO,PAID_TYPES.DESCA,CONVERT(VARCHAR(10),FILE6_20H.DATE,111),YEARS_CODES.[YEAR], FILE1_10.DESCA" & _
...
listarray(3, 0) = "”‰… «·”œ«œ"
listarray(3, 1) = "(**YEARS_CODES.[YEAR]**)"
...
CardLookup
End Sub
Private Sub cmdLateTax_Click()
Dim oTax As New ShowTaxLatefrm
oTax.pCode = xCode.text
oTax.pDate = xDate.text
oTax.Show 1
End Sub
Private Sub cmdLateTaxInstall_Click()
Dim oTax As New ShowTaxInstallfrm
oTax.pCode = xCode.text
oTax.pDate = xDate.text
oTax.Show 1
End Sub
...
Inform " „ Õ›Ÿ «·„” ‰œ »‰Ã«Õ"
If sDoc_no <> "" Or (Not myForm Is Nothing) Then
    Unload Me
    Exit Sub
End If
'openCardTable
...
Private Sub cmdTaxLate_Click()

End Sub

Private Sub cmdTaxIntsallDtl_Click()
If Not ValidNum(xCode.text) Then Exit Sub
ShowTaxInstallDtlfrm.pCode = xCode.text
...
xRenew.Value = IIf(CardTable!Renew, 1, 0)
xAdmit.Value = IIf(CardTable!ADMIT, 1, 0)

bIgCheck = True
xDate_change.Value = IIf(CardTable!DATE_CHANGE, 1, 0)
bIgCheck = False

xYears_desca.Caption = CardTable!years_desca & ""
xFawry.Value = IIf(CardTable!Isfawry, 1, 0)
LoadMember
...
cString = "SELECT FILE6_20.[ITEM],FILE6_10.DESCA ,FILE6_20.[VALUE],[QUANT],[DISCOUNT_RATE],[TAX_RATE]" & _
          ",FILE6_20.LATE_RATE,FILE6_20.[TOTAL],FILE6_20.NOTES,FILE6_20.TAX_BEFORE,TAX_BEFORE_LATE,FILE6_20.[ID]" & _
...
grid1.BackColorFixed = IIf(xFawry.Value = 0, &HE0E0E0, &HE0E0E0)
grid1.BackColorFixed = IIf(xFawry.Value = 0, &HE0E0E0, &HE0E0E0)
...
'bEditRecord = bedit And xClosed.Value = 0 And (xForm_No.text = "" Or (xFawry.Value = 1))
bEditRecord = bedit And xClosed.Value = 0 And xForm_No.text = ""
cmdAddItems.Enabled = nMode = DefineMode
xRenew.Enabled = bEditRecord And nMode = DefineMode
cmdYearChange.Enabled = nMode = LoadMode And bopt1 = True
cmdTotal.Enabled = nMode = LoadMode
Me.cmdLateTax.Enabled = nMode = LoadMode
...
xAdmit.Enabled = nMode = DefineMode

xDate_change.Enabled = nMode = LoadMode And bEditRecord And xDate_change.Value = 0 And myFormat(xDate.text) <> myFormat(Date)
...
Private Sub optFawry_Click(Index As Integer)
myUndo
End Sub
...
Private Sub xDate_change_Click()
If Not bIgCheck Then
    If xDate_change.Value = 1 Then
        If myFormat(xDate.text) = myFormat(Date) Then
            MsgBox "‰›” «· «—ÌŒ "
            Exit Sub
        End If
        
        If DateDiff("d", myFormat(xDate.text), Date) >= 7 Then
            MsgBox "«· «—ÌŒ  ⁄œÌ «·«Ì«„ «·„”„ÊÕ »Â«"
            Exit Sub
        End If

        If MsgBox(" ⁄œÌ· «· «—ÌŒ", vbDefaultButton2 + vbOKCancel) <> vbOK Then Exit Sub
        
        con.Execute "update file6_20h set " & _
                    " [date] = " & DateSq(Date) & _
                    ",FILE6_20H.DATE_CHANGE = 1" & _
                    " where doc_no = " & xdoc_no.text
        myUndo
    Else
        con.Execute "update file6_20h SET " & _
                    " FILE6_20H.DATE_CHANGE = 1" & _
...
xDate_change.Enabled = xdoc_no.Tag = LoadMode And bEditRecord And xDate_change.Value = 0 And myFormat(xDate.text) <> myFormat(Date)
End Sub
...
With grid1
.RowHeight(0) = 700
.FormatString = "ﬂÊœ «·»‰œ|" & "«·»Ì«‰|" & "«·ﬁÌ„…|" & "⁄œœ|" & "‰”»… Œ’„|" & "‰”»… ﬁÌ„… „÷«›…|" & "‰”»… €—«„…|" & "«·≈Ã„«·Ì|" & "„·ÕÊŸ…|" & "÷—Ì»… „” Õﬁ…|" & "€—«„… ÷—Ì»… „” Õﬁ…|"
.ColWidth(0) = 800
.ColWidth(1) = 3000
.ColWidth(2) = 1100
.ColWidth(3) = 1000
...
If optFawry(1).Value Then
    cFilter = "FILE6_20H.IsFawry = 0"
ElseIf optFawry(2).Value Then
    cFilter = "FILE6_20H.IsFawry = 1"
End If
...
cString = "SELECT FILE6_20.DOC_NO,TYPE_CODES.DESCA AS TYPE_DESCA,FILE6_20H.CODE,FILE6_20H.DATE,FILE6_20H.TOTAL_YEAR,FILE6_20H.TOTAL_YEAR_OTHER,FILE6_20.TOTAL,FILE1_10.DESCA AS DESCA_MEMBER,FILE6_10.DESCA AS ITEM_DESCA,PAID_TYPES.DESCA AS PAID_TYPE_DESCA," & _
          "(FILE6_20.TOTAL_ITEM),FILE6_20.TOTAL AS TOTAL_ROW,FILE6_20.TAX,FILE6_20.TOTAL_DISCOUNT ,FILE6_20.DISCOUNT_RATE,FILE6_20H.TOTAL_LATE,FILE6_20H.TOTAL_TAX,FILE6_20H.TOTAL,FILE6_20H.[TYPE],PAID_TYPES.IS_PAID" & _
...
Dim nTotal_Tax_Year As Variant
nTotal_Tax_Year = mRound(GetField("Select sum(file6_20.tax) from file6_20 inner join file6_20h on file6_20.doc_no = file6_20h.doc_no where file6_20.doc_no = " & xdoc_no.text & " and file6_20.year_code <> file6_20h.year_code", con))
...
Do Until loctable.EOF
    ...
    temptable!memo1 = ArbString("«ﬁ— «‰«/" & Space(2) & !Desca_Member & " »√‰ Ã„Ì⁄ »Ì«‰«  √”— Ì (“ÊÃ Ì Ê«Ê·«œÌ Ê«Ì  Ê«»⁄ „÷«›… (Ê«·œ/Ê«·œ…/‘ﬁÌﬁ/‘ﬁÌﬁ…)" & _
                      " ’ÕÌÕ… Ê⁄·Ì „”∆Ê·Ì Ì Ê«‰ «·«»‰«¡ „‰ «·–ﬂÊ— «Ê «·«‘ﬁ«¡ „« “«·Ê« ›Ï «·„—«Õ· «· ⁄·Ì„Ì… Ê«‰ «·»‰«  „‰ «·«»‰«¡ «Ê «·‘ﬁÌﬁ«  ·„ Ì “ÊÃ‰ Õ Ì  «—ÌŒÂ" & _
                      " ÊÂÌ „ÿ«»ﬁ… ·»Ì«‰« Ì »«” „«—… «·⁄÷ÊÌ… Ê«‰ «·«”„«¡ «·Ê«—œ… »⁄«·ÌÂ Â„ «·„ﬁÌœÌ‰ »⁄÷ÊÌ Ì Ê›Ì Õ«·… À»Ê  «Ì „Œ«·›… ÌÕﬁ ··‰«œÌ «”ﬁ«ÿ «·⁄÷ÊÌ….")
        
    temptable!str6 = loctable!item_Desca
    temptable!val4 = mRound(loctable!total_year)
    temptable!VAL5 = mRound(loctable!TOTAL_YEAR_OTHER) + mRound(loctable!TOTAL_LATE) + nTotal_Tax_Year
    temptable!VAL6 = 0
    temptable!VAL7 = 0
    
    temptable!VAL8 = mRound(loctable!total)
    temptable!STR15 = MyOnly(loctable!total)
    temptable!VAL15 = mRound(loctable!TAX)
    
    temptable!val11 = IIf(loctable!IS_PAID, 0, 1)
    ...
    If loctable!Type = 1 Then
        temptable!str19 = "≈Ì’«· ”œ«œ Ê ÕœÌÀ »Ì«‰« "
    Else
        temptable!str19 = "≈Ì’«· " & !PAID_TYPE_DESCA
    End If
...
If False Then
    Set loctable = New ADODB.Recordset
    atype = Claim_Type_Load(xType.BoundText, , con)
    If retFlag(atype, "Type") = 100 Then
        Dim aPrm As Variant
        aPrm = AddFlag(aPrm, "code", xCode.text)
        aPrm = AddFlag(aPrm, "date", myFormat(xDate.text))
        
        Set loctable = myCmdProc("dbo.pr_tax_dtl", con, aPrm)
        Do Until loctable.EOF
            temptable.AddNew
            temptable!str1 = loctable!year_desca
            temptable!str2 = myFormat_p(loctable!Date)
            temptable!str3 = loctable!doc_no
            temptable!str4 = loctable!item_Desca
            temptable!VAL1 = loctable!value_all
            temptable!VAL20 = 3
            temptable.Update
            loctable.MoveNext
        Loop
        
        If loctable.RecordCount Then contemp.Execute "update temp set val21 = 1"
    End If
End If

Dim nType_Claim As String
nType_Claim = retFlag(Claim_Type_Load(xType.BoundText, , con), "Type")
...
Report1.ReportFileName = App.Path & IIf(nType_Claim = "100" Or nType_Claim = "200" Or nType_Claim = "300", "\Reports\paid_emp_short.rpt", "\Reports\paid_emp.rpt")
...
If False Then
    cString = "SELECT PAID_TYPES.PRINT_DTL " & _
              " FROM FILE6_20H INNER JOIN PAID_TYPES ON FILE6_20H.TYPE = PAID_TYPES.CODE" & _
              " WHERE DOC_NO = " & MyParn(xdoc_no.text)
    If myField(cString, "PRINT_DTL", con, , False) Then
        Report1.Reset
        Report1.WindowState = crptMaximized
        Report1.ReportFileName = App.Path & "\Reports\paid_dtl.rpt"
        Report1.DataFiles(0) = tempFile
        Report1.WindowShowPrintSetupBtn = True
        Report1.ProgressDialog = False
        Report1.CopiesToPrinter = 1
...
Err.Clear
End Function
Private Function ApplyFawry(pDoc_No) As Boolean
Dim nTotal As Double, nPaid As Double
nTotal = mRound(GetField("select file6_20h.total from file6_20h where doc_no = " & addvalue(pDoc_No), con), 2)
nPaid = mRound(GetField("select [dbo].[fawry_acount](" & addvalue(xCode.text) & ")", con))
If nTotal > nPaid Then
    If mRound(nTotal - nPaid, 2) > 0.25 Then
        MsgBox "Õ”«» «·⁄„Ì· «ﬂ»— „‰ ”œ«œ ›Ê—Ì »ﬁÌ„… " & mRound(nTotal - nPaid, 2)
        Exit Function
    End If
End If
ApplyFawry = True
...
If xFawry.Value = 0 And xForm_No.text <> "" Then
    grid1.BackColorFixed = &HC0FFC0
    grid2.BackColorFixed = &HE0E0E0
Else
    grid1.BackColorFixed = &HC0FFC0
    grid1.BackColorFixed = &HC0FFC0
End If
...
If Not loctable.EOF Then
    cmdAddItemsOther.Caption = "«÷«›… »‰Êœ „ÿ«·»… " & loctable!Desca
    cmdAddItemsOther.Tag = loctable!code
End If
End Sub
