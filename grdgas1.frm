...
Begin VB.Form grdgasfrm1 
   Caption         =   " ›’Ì·Ì „”ÕÊ»«  ÊﬁÊœ «·”Ì«—« "
   ClientHeight    =   10110
   ClientLeft      =   90
   ClientTop       =   465
   ClientWidth     =   16785
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.TextBox xDate2 
         ...
         Width           =   1635
      End
      Begin MSDataListLib.DataCombo xKind 
         Height          =   360
         Left            =   90
         TabIndex        =   2
         Top             =   900
...
If xKind.BoundText <> "" Then aHeader(1) = "‰Ê⁄ «·ÊﬁÊœ : " & xKind.Text
...
data1.RecordSource = "Select Code,DescA From kind_gas_codes"
Set xKind.RowSource = data1
xKind.ListField = "Desca"
xKind.BoundColumn = "Code"
...
If xKind.MatchedWithList Then
    cString = cString & turn(cString) & "TYPE_GAS_CODES.KIND = " & xKind.BoundText
End If
...
If Not xKind.MatchedWithList Then
    MsgBox "‰Ê⁄ «·ÊﬁÊœ €Ì— „”Ã·"
    Exit Function
End If
MYVALID = True
