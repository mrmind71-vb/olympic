...
Begin VB.Form report_insfrm8 
   ...
   End
End
Attribute VB_Name = "report_insfrm8"
...
Dim aHeader(11)
cField = myiif("INSTALL_BALANCE.VALUE - INSTALL_BALANCE.VALUE_PAID  <= 0", "1") & " AS PAID_COUNT"
cString = "Select file2_10.CODE,FILE2_10.DESCA,FILE2_10.INSTALL_COUNT,FILE2_10.PHONE,FILE2_10.ADDRESS,dbo.f_last_year_date_install(FILE2_10.CODE) AS LAST_DATE_PAID,INSTALL_CODES.DESCA AS INSTALL_DESCA,FILE2_10.DATE_BEGIN,FILE2_10.DATE_END,FILE2_10.INSTALL_COUNT,FILE2_10.VALUE,FILE2_10.INSTALL_VALUE,SUM(INSTALL_BALANCE.VALUE_PAID) AS PAID  ," & cField & _
...
Do Until sourcetable.EOF
    ...
    temptable!VAL5 = mRound(sourcetable!paid_count)
    temptable!VAL6 = mRound(sourcetable!install_count) - mRound(sourcetable!paid_count)
...
Else
    ...
    contemp.CommitTrans
    If pReport = "" Then
        REPORT1.ReportFileName = sPath_App & "\REPORTS\REPORT_INS8.rpt"
    Else
