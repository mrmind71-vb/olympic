...
Begin VB.Form grdTax6 
   Caption         =   "ÓÏÇÏ ÝÑæÞ ÞíãÉ ãÖÇÝÉ "
   ClientHeight    =   10110
   ClientLeft      =   90
   ClientTop       =   465
   ClientWidth     =   20250
   ...
   Begin VB.Frame Frame2 
      ...
      Begin Threed.SSCommand cmdPrintLand 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "grdTax6.frx":7149
         Caption         =   "ØÈÇÚÉ"
         ButtonStyle     =   1
         PictureAlignment=   10
         BevelWidth      =   0
         PictureDisabledFrames=   1
         PictureDisabled =   "grdTax6.frx":A147
      End
   End
...
Set data10.Recordset = myCmdProc("dbo.sp_paid_late", con, aPrm)
End With
Fixgrd
Handlecontrols
End Sub
