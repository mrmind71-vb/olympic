...
Begin VB.Form ClientReport3 
   ...
   End
End
Attribute VB_Name = "ClientReport3"
...
cString = "SELECT FILE3_10.CODE, FILE8_10.DOC_NO , FILE3_10.DESCA AS CustName , FILE8_10.DATE, FILE8_10.desca, FILE8_10.VALUE, FILE8_10.doc FROM FILE3_10 RIGHT JOIN FILE8_10 ON FILE3_10.CODE = FILE8_10.CODE " & _
          "WHERE FILE8_10.code is not null "
If xclient.Text <> "" Then cString = cString & " AND FILE8_10.CODE = " & MyParn(xclient.Text)
If IsDate(xdate1.Text) Then cString = cString & " AND FILE8_10.DATE >= " & DateSql(xdate1.Text)
If IsDate(xDate2.Text) Then cString = cString & " AND FILE8_10.DATE <= " & DateSql(xDate2.Text)
cString = cString & " GROUP BY FILE3_10.CODE, FILE8_10.DOC_NO ,FILE3_10.DESCA, FILE8_10.DATE, FILE8_10.desca, FILE8_10.VALUE, FILE8_10.doc "
...
cString = " SELECT file5_22.DATE, FILE5_20.DATE_1, FILE5_20.SER_NO, file5_22.VALUE, FILE5_20.NAME1 FROM FILE5_20 INNER JOIN file5_22 ON FILE5_20.SER_NO = file5_22.ser_no " & _
          " WHERE FILE5_20.code is not null "
If xclient.Text <> "" Then cString = cString & " AND FILE5_20.CODE = " & MyParn(xclient.Text)
If IsDate(xdate1.Text) Then cString = cString & " AND FILE5_22.DATE >= " & DateSql(xdate1.Text)
If IsDate(xDate2.Text) Then cString = cString & " AND FILE5_22.DATE <= " & DateSql(xDate2.Text)
...
Do
    ...
    TargetTable.str4 = " ‘Ìﬂ Õﬁ " & Format(SourceTable.date_1, "DD-MM-YYYY")
...
cString = "Select FILE1_10.PACK , File1_11.Item ,File1_11.Code," & _
          ...
          " From ((File1_11 Inner Join File1_10 on File1_11.Item = File1_10.Item)" & _
                " Inner Join File3_10 on File1_11.Code = File3_10.Code) " & _
...
Do
    ...
    TargetTable.str2 = SourceTable.[FILE3_10.DESCA]
...
If Not MYVALID Then Exit Sub
tempdb.Execute "DELETE * FROM TEMP"
cString = "Select File3_11.*," & _
           "File3_10.DescA" & _
          " From File3_11 inner Join file3_10 on file3_10.Code = File3_11.Code" & _
          " Where File3_11.Code = " & MyParn(xclient.Text) & " And " & _
...
Do
    ...
    TargetTable.str4 = SourceTable.[FILE3_11.DESCA]
...
NRETURN = 0
Set ClientMove = mydb.CreateDynaset("select * from file3_11 where code = " & MyParn(Client))
...
If publicFlag = 3 Then
    cString = "Select file6_20.*,File1_10.DescA,File1_10.PACK " & _
...
Else
    cString = "Select File6_10.*,File1_10.DescA ,File1_10.PACK " & _
              " From File6_10 inner join file1_10 on File6_10.ITEM = file1_10.item " & _
              " Where CODE = " & MyParn(xclient.Text) & _
              " and Date between DateValue(" & MyParn(xdate1.Text) & ")" & _
              " and DateValue(" & MyParn(xDate2.Text) & ")" & _
              " order by Date,DOC_NO "
...
cString = "Select file6_10.*,File1_10.DescA " & _
          "From file6_10 inner join file1_10 on file6_10.itemCode = file1_10.item " & _
           cCondition & _
...
Set ClientTable = mydb.OpenRecordset("SELECT * FROM file3_10")
Set TempTable = tempdb.OpenRecordset("TEMP")
Set FlagTable = mydb.OpenRecordset("File1_70")
Set CompBalance = mydb.OpenRecordset("File3_20")
End Sub
Function MYVALID()
...
If publicFlag = 1 Then
    cString = "Select File6_20.DOC_NO, " & _
              "File6_20.DATE," & _
              "Sum(File6_20.Total) as sumTotal " & _
              "From file6_20 " & _
              "Where file6_20.CODE = " & MyParn(xclient.Text) & _
              " And FILE6_20.DATE Between DateValue(" & MyParn(xdate1.Text) & ") and DateValue(" & MyParn(xDate2.Text) & ")" & _
              " Group by DOC_NO,FILE6_20.DATE"
Else
    cString = "Select File6_10.DOC_NO," & _
              "File6_10.DATE," & _
              "Sum(File6_10.Total) as sumTotal " & _
              "From file6_10 " & _
              "Where file6_10.CODE = " & MyParn(xclient.Text) & _
