...
Begin VB.Form grdDriverfrm2 
   ...
   End
End
Attribute VB_Name = "grdDriverfrm2"
...
cHead1 = "ãÊÇÈÚÉ ÊÌÏíÏ ÑÎÕ ÓíÇÑÇÊ"
...
cString = "Select CARS.CODE,CARS.DESCA,CARS.MODEL,CARS.BOARD,CARS.LINE,CONVERT(VARCHAR(10),CARS.DATE_AUTH,111),CONVERT(VARCHAR(10),CARS.DATE_AUTH_END,111)  " & _
          " FROM CARS"

If IsDate(xDate1.Text) Then
    cString = cString & turn(cString) & "CARS.DATE_AUTH_END >= " & DateSq(xDate1.Text)
End If
          
If IsDate(xDate2.Text) Then
    cString = cString & turn(cString) & "CARS.DATE_AUTH_END <= " & DateSq(xDate2.Text)
End If
cString = cString & " Order by CARS.DATE_AUTH_END"
...
Dim nTotal_Sales As Double, nTotal_in As Double
    ...
    .TextMatrix(0, 0) = "ã"
    .TextMatrix(0, 1) = "ÑÞã ÇáÓíÇÑÉ"
    .TextMatrix(0, 2) = "ÇáÈíÇä"
    .TextMatrix(0, 3) = "ÇáãæÏíá"
    .TextMatrix(0, 4) = "ÑÞã ÇááæÍÉ"
    .TextMatrix(0, 5) = "ÇáÎØ"
