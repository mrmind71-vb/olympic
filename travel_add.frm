...
Begin VB.Form travel_addfrm 
   ...
   End
End
Attribute VB_Name = "travel_addfrm"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Public sCode As String, sCode_Desca As String
...
With grid1
cString = "SELECT Distinct TRAVEL_H.DOC_NO,Convert(VARCHAR(10),TRAVEL_H.[DATE],111),TRAVEL_H.POLICY,Convert(VARCHAR(10),TRAVEL_H.DATE_POLICY,111),TRAVEL_H.DESCA,PLACE_CODES.DESCA,PLACE_CODES_B.DESCA,TRAVEL_H.WEIGHT,TRAVEL_H.CLASS,TRAVEL_H.TOTAL , 1 AS [ADD]" & _
...
cString = cString & turn(cString) & "(FILE6_20.TRAVEL IS NULL)"
cString = cString & turn(cString) & "TRAVEL_H.CODE = " & MyParn(sCode)
cString = cString & turn(cString) & "(NOT DATE_POLICY IS NULL)"
...
Dim cÚString As String
With grid2
cString = "SELECT Distinct TRAVEL_H.DOC_NO,Convert(VARCHAR(10),TRAVEL_H.[DATE],111),TRAVEL_H.DESCA,PLACE_CODES.DESCA,PLACE_CODES_B.DESCA,TRAVEL_H.TOTAL " & _
          " FROM  TRAVEL_H INNER JOIN FILE3_10 ON TRAVEL_H.CODE = FILE3_10.CODE LEFT JOIN FILE6_20 ON TRAVEL_H.DOC_NO = FILE6_20.TRAVEL" & _
            " LEFT JOIN PLACE_CODES ON TRAVEL_H.PLACE1 = PLACE_CODES.CODE " & _
            " LEFT JOIN PLACE_CODES AS PLACE_CODES_B ON TRAVEL_H.PLACE2 = PLACE_CODES_B.CODE "
...
cString = cString & turn(cString) & "(FILE6_20.TRAVEL IS NULL)"
cString = cString & turn(cString) & "TRAVEL_H.CODE = " & MyParn(sCode)
cString = cString & turn(cString) & "(DATE_POLICY IS NULL)"
cString = cString & " Order by Convert(VARCHAR(10),TRAVEL_H.[DATE],111),TRAVEL_H.DOC_NO"
