...
Begin VB.Form grdpaid_sport1 
   Caption         =   "ÅÌãÇáí ÇíÕÇáÇÊ ÓÏÇÏ äÔÇØ ÕíÝí"
   ClientHeight    =   10110
   ClientLeft      =   90
   ClientTop       =   465
   ClientWidth     =   16785
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.CommandButton cmdGo 
         Height          =   555
         Left            =   3645
         Picture         =   "grdpaid_sport1.frx":0000
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   11
         ToolTipText     =   "ÚÑÖ"
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   555
         Left            =   2415
         Picture         =   "grdpaid_sport1.frx":3059
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   10
         Top             =   135
      ...
      Begin VB.CommandButton cmdExit 
         Height          =   555
         Left            =   45
         Picture         =   "grdpaid_sport1.frx":5483
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   9
         Top             =   135
      ...
      Begin VB.CommandButton cmdExel 
         Height          =   555
         Left            =   1215
         Picture         =   "grdpaid_sport1.frx":78EF
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   8
         ToolTipText     =   "ÚÑÖ"
