...
Dim aHeader(11)
cString = "Select file1_10.*,RELIGION_CODES.DescA as RELIGION_Desca,FILE1_10.PHONE,FILE1_10.MOBIL " & _
          " From File1_10 INNER join RELIGION_CODES on File1_10.RELIGION = RELIGION_CODES.CODE"
If Check1.Value = 1 Then
    cWhere = cWhere & turn(cWhere, " and ") & "(NOT (FILE1_10.MOBIL IS NULL AND FILE1_10.PHONE IS NULL) )"
End If

If xReligion.MatchedWithList Then
    aHeader(0) = "«·œÌ«‰… : " & xReligion.text
    cWhere = cWhere & turn(cWhere, " and ") & "FILE1_10.RELIGION = " & addvalue(xReligion.BoundText)
End If
...
Do Until sourcetable.EOF
    ...
    'temptable!str3 = TurnValue(sourcetable!RELIGION_desca)
...
6    Report1.ReportFileName = sPath_App & "\REPORTS\REPORT6.rpt"
...
Set data1.Recordset = myRecordSet("SELECT CODE,DESCA FROM RELIGION_CODES ORDER BY CODE", con)
Set xReligion.RowSource = data1
