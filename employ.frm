   ...
   Begin VB.Frame Frame8 
      ...
      Begin Threed.SSCommand cmdLast 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "employ.frx":E361
         Caption         =   "«ŒÌ—"
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "employ.frx":10531
      End
      Begin Threed.SSCommand cmdNext 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "employ.frx":12679
         Caption         =   "·«Õﬁ "
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "employ.frx":14841
      End
      Begin Threed.SSCommand cmdPrevious 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "employ.frx":16990
         Caption         =   "”«»ﬁ"
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "employ.frx":18B70
      End
      Begin Threed.SSCommand cmdFirst 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "employ.frx":1ACCB
         Caption         =   "√Ê·"
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "employ.frx":1CE87
      End
   End
...
cString = "SELECT * FROM SALARY_CODES"
Set data3.Recordset = myRecordSet(cString, con)
Set xSalary_Codes.RowSource = data3
xSalary_Codes.ListField = "Desca"
xSalary_Codes.BoundColumn = "Code"
...
xFirst_Balance.Text = Myvalue(CardTable!First_Balance)
'XISDAY.Value = IIf(CardTable!ISDay, 1, 0)
xSalary.Text = Myvalue(CardTable!Salary)
xSalary_Codes.BoundText = CardTable!SALARY_CODE & ""
...
aInsert = AddFlag(aInsert, "DRIVER", xDriver.Value)
aInsert = AddFlag(aInsert, "SALARY", Val(xSalary.Text))
aInsert = AddFlag(aInsert, "SALARY_CODE", addvalue(xSalary_Codes.BoundText))
aInsert = AddFlag(aInsert, "FIRST_BALANCE", Val(xFirst_Balance.Text))
'aInsert = AddFlag(aInsert, "ISDAY", XISDAY.Value)
