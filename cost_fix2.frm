...
xdate1.Text = Format(RetSetting("DATE1", TempSave(Me, nFlag & "")), "YYYY-MM-DD")
XDATE2.Text = Format(RetSetting("DATE2", TempSave(Me, nFlag & "")), "YYYY-MM-DD")
openCon con
If nFlag = 0 Then
...
cString = "SELECT FILE6_20.ITEM,FILE6_20.ID,FILE6_20H.DATE FROM FILE6_20 INNER JOIN FILE6_20H ON FILE6_20.DOC_NO = FILE6_20H.DOC_NO"
...
Do Until loctable.EOF
    ...
    cString = "UPDATE FILE6_20 SET FILE6_20.COST = " & LastCostDate(loctable!Item, Format(loctable!Date, "YYYY-MM-DD"), con)
    cString = cString & turn(cString) & "FILE6_20.ID = " & loctable!ID
...
Do Until loctable.EOF
    I = I + 1
    prog1.Value = Round(I / (nRecordCount), 2) * 100
    cString = "UPDATE FILE1_60 SET FILE1_60.COST = " & LastCostDate(loctable!Item, Format(loctable!Date, "YYYY-MM-DD"), con)
