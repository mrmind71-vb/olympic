...
cField = cField & "," & _
        myiif(cWhere & turn(cWhere, " And ") & " ( FLAG = 1)", "[VALUE]") & " AS CHARGES"

cField = cField & "," & _
        myiif(cWhere & turn(cWhere, " And ") & " ( FLAG = 2)", "[VALUE]") & " AS ITEMS"

cField = cField & "," & _
        myiif(cWhere & turn(cWhere, " And ") & " ( FLAG = 3)", "[VALUE]") & " AS SOLAR"

cField = cField & "," & _
        myiif(cWhere & turn(cWhere, " And ") & " ( FLAG = 4)", "[VALUE]") & " AS OIL"

cField = cField & "," & _
        myiif(cWhere & turn(cWhere, " And ") & " ( FLAG = 5)", "[VALUE]") & " AS OIL2"

cWhere = ""
If IsDate(xdate2.Text) Then cWhere = " date <= " & DateSq(xdate2.Text)
cField = cField & "," & _
         myiif(cWhere, "VALUE") & " AS endbal "
...
'                           0               1                 2                3
    ...
    With GRID1
    cString = cString & " GROUP BY CAR_MOVE.CAR, CARS.DESCA"
