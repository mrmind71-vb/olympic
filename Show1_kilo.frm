...
cString = "SELECT TOP 100 FILE8_50H.DOC_NO AS [—ﬁ„ «·„” ‰œ], FILE8_50.DESCA AS [«·»Ì«‰], FILE8_50.[VALUE] AS [«·ﬁÌ„…], CONVERT(VARCHAR(10),FILE8_50H.DATE,111) AS [«· «—ÌŒ],'' AS [«·„œ…],'' as [»«·ﬂÌ·Ê]" & _
