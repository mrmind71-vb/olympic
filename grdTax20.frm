...
Begin VB.Form grdTax20 
   Caption         =   "ÓÏÏ ÝÑæÞ ÞíãÉ ãÖÇÝÉ ÔåÑí ááÇÚÖÇÁ"
   ClientHeight    =   10110
   ClientLeft      =   90
   ClientTop       =   465
   ClientWidth     =   20250
   ...
   Begin VB.Frame Frame2 
      ...
      Begin Threed.SSCommand cmdPrintLand 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "grdTax20.frx":7149
         Caption         =   "ØÈÇÚÉ"
         ButtonStyle     =   1
         PictureAlignment=   10
         BevelWidth      =   0
         PictureDisabledFrames=   1
         PictureDisabled =   "grdTax20.frx":A147
      End
   End
...
Set data10.Recordset = myCmdProc("dbo.sp_paid_late_install_month", con, aPrm)
End With
Fixgrd
Handlecontrols
End Sub
...
Dim nTotal_Sales As Double, nTotal_in As Double
    ...
    .TextMatrix(0, 2) = "ÚÏÏ ÇáÇíÕÇáÇÊ"
    .TextMatrix(0, 3) = "ÅÌãÇáí ÇáÞíãÉ"
    ...
    If .rows > 1 Then
        .TextMatrix(.rows - 1, 0) = "ÇáÅÌãÇáì"
        .TextMatrix(.rows - 1, 3) = mRound(.ValueMatrix(.rows - 1, 3))
    End If
