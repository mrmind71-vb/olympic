...
Begin VB.Form trust_addfrm 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Left            =   1260
         MaskColor       =   &H00FFFFFF&
         Picture         =   "travel_trust2.frx":0000
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   6
         TabStop         =   0   'False
      ...
      Begin VB.CommandButton cmdFilter 
         Height          =   510
         Left            =   2430
         Picture         =   "travel_trust2.frx":2363
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   4
         ToolTipText     =   "⁄—÷"
      ...
      Begin VB.CommandButton cmdExit 
         Height          =   510
         Left            =   45
         Picture         =   "travel_trust2.frx":4855
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   11
         TabStop         =   0   'False
...
cString = "SELECT TRAVEL_H.DOC_NO,Convert(VARCHAR(10),TRAVEL_H.[DATE],111),FILE3_10.Desca,TRAVEL_H.POLICY," & _
          " Convert(VARCHAR(10),TRAVEL_H.[DATE_POLICY],111),DRIVER.DESCA,CARS.BOARD,FILE4_10.DESCA,TRAVEL_H.PLACE1,TRAVEL_H.PLACE2" & _
          " ,TRUST_BAL.TRUST,TRUST_BAL.CHARGE,TRUST_BAL.BALANCE " & _
...
Dim cÚString As String
With GRID2
cString = "SELECT Distinct TRAVEL_H.DOC_NO,Convert(VARCHAR(10),TRAVEL_H.[DATE],111),TRAVEL_H.DESCA,TRAVEL_H.PLACE1,TRAVEL_H.PLACE2,TRAVEL_H.TOTAL " & _
          " FROM  TRAVEL_H INNER JOIN FILE3_10 ON TRAVEL_H.CODE = FILE3_10.CODE LEFT JOIN FILE6_20 ON TRAVEL_H.DOC_NO = FILE6_20.TRAVEL"
