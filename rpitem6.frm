...
cString = "SELECT Sum( PURCHASENET.[IN] -  PURCHASENET.OUT ) as SumOfQuant, Sum(PURCHASENET.FLAG * TOTAL) as SumOfCost ,FILE1_10.ITEM,FILE1_10.DESCA, FILE1_10.PRICE, FILE1_50.DESCA AS FILE1_50DESCA,FILE1_10.[GROUP] " & _
