...
Begin VB.Form grdtrans_box 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.CommandButton cmdGo 
         Height          =   555
         Left            =   3600
         Picture         =   "grd_trans_box.frx":0000
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   13
         ToolTipText     =   "⁄—÷"
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   555
         Left            =   2415
         Picture         =   "grd_trans_box.frx":3059
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   12
         Top             =   135
      ...
      Begin VB.CommandButton cmdExit 
         Height          =   555
         Left            =   45
         Picture         =   "grd_trans_box.frx":5483
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   11
         Top             =   135
      ...
      Begin VB.CommandButton cmdExel 
         Height          =   555
         Left            =   1215
         Picture         =   "grd_trans_box.frx":78EF
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   10
         ToolTipText     =   "⁄—÷"
   ...
   End
End
Attribute VB_Name = "grdtrans_box"
...
If xbox.MatchedWithList Then aHeader(1) = "«·Œ“‰… : " & xbox.Text
If xbox1.MatchedWithList Or xbox2.MatchedWithList Then aHeader(2) = BetweenString(xbox1.Text, xbox2.Text)
cHead2 = retHeader(aHeader, 0, 1)
cHead3 = retHeader(aHeader, 1, 3)
...
If xbox.MatchedWithList Then
    cString = cString & turn(cString) & "NO1 = " & MyParn(xbox.BoundText) & " OR NO2 = " & MyParn(xbox.BoundText)
End If
If xbox1.MatchedWithList And xbox2.MatchedWithList And Check1.Value Then
    cString = cString & turn(cString) & "(NO1 = " & MyParn(xbox1.BoundText) & " OR NO2 = " & MyParn(xbox1.BoundText) & ")" & _
              " AND " & "(NO1 = " & MyParn(xbox2.BoundText) & " OR NO2 = " & MyParn(xbox2.BoundText) & ")"
Else
    If xbox1.MatchedWithList Then cString = cString & turn(cString) & "NO1 = " & MyParn(xbox1.BoundText)
    If xbox2.MatchedWithList Then cString = cString & turn(cString) & "NO2 = " & MyParn(xbox2.BoundText)
End If
...
End If
cString = cString & " Order by DATE,CODE"
...
Dim nTotal_Sales As Double, nTotal_in As Double
    ...
    If .rows > 1 Then
        ...
        .Subtotal flexSTSum, -1, 5, "#0.00", &HC0FFC0, vbBlack, True, "  "
        For I = 0 To 1
            .TextMatrix(1, I) = "«·≈Ã„«·Ï"
        Next
...
If KeyCode = 112 Then BoxLookupAll Me, oSearch
End Sub

Private Sub xbox1_KeyUp(KeyCode As Integer, Shift As Integer)
If KeyCode = 112 Then BoxLookupAll Me, oSearch

End Sub

Private Sub xbox2_KeyUp(KeyCode As Integer, Shift As Integer)
If KeyCode = 112 Then BoxLookupAll Me, oSearch
End Sub
