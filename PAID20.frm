...
Begin VB.Form paidfrm 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabHeight       =   520
      TabCaption(0)   =   "Tab 0"
      TabPicture(0)   =   "PAID20.frx":0000
      Tab(0).ControlEnabled=   0   'False
      Tab(0).Control(0)=   "grid1(0)"
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "Tab 1"
      TabPicture(1)   =   "PAID20.frx":001C
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "grid1(1)"
      Tab(1).ControlCount=   1
      TabCaption(2)   =   "Tab 2"
      TabPicture(2)   =   "PAID20.frx":0038
      Tab(2).ControlEnabled=   0   'False
      Tab(2).Control(0)=   "grid1(2)"
      Tab(2).ControlCount=   1
      TabCaption(3)   =   "Tab 3"
      TabPicture(3)   =   "PAID20.frx":0054
   ...
   Begin VB.Frame Frame3 
      ...
      Begin Threed.SSCommand cmdFirst 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "PAID20.frx":0070
         Caption         =   "√Ê·"
         ButtonStyle     =   3
         PictureAlignment=   10
         BevelWidth      =   0
         PictureDisabledFrames=   1
         PictureDisabled =   "PAID20.frx":2217
      End
      Begin Threed.SSCommand cmdPrevious 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "PAID20.frx":425E
         Caption         =   "”«»ﬁ"
         ButtonStyle     =   3
         PictureAlignment=   10
         BevelWidth      =   0
         PictureDisabledFrames=   1
         PictureDisabled =   "PAID20.frx":6349
      End
      Begin Threed.SSCommand cmdNext 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "PAID20.frx":8343
         Caption         =   "·«Õﬁ"
         ButtonStyle     =   3
         PictureAlignment=   9
         BevelWidth      =   0
         PictureDisabledFrames=   1
         PictureDisabled =   "PAID20.frx":A454
      End
      Begin Threed.SSCommand cmdLast 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "PAID20.frx":C44E
         Caption         =   "√ŒÌ—"
         ButtonStyle     =   3
         PictureAlignment=   9
         BevelWidth      =   0
         PictureDisabledFrames=   1
         PictureDisabled =   "PAID20.frx":E672
      End
   End
   ...
   Begin VB.Frame Frame1 
      ...
      Begin Threed.SSCommand cmdInform 
         ...
         PictureDisabledFrames=   1
         ShapeSize       =   1
         PictureDisabled =   "PAID20.frx":12B0E
      End
      Begin Threed.SSCommand cmdAdd 
         ...
         PictureDisabledFrames=   1
         ShapeSize       =   1
         PictureDisabled =   "PAID20.frx":16BBF
      End
      Begin Threed.SSCommand cmddel 
         ...
         PictureDisabledFrames=   1
         ShapeSize       =   1
         PictureDisabled =   "PAID20.frx":1B312
      End
      ...
      Begin Threed.SSCommand cmdPrint 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "PAID20.frx":1FAC9
         ButtonStyle     =   3
         PictureAlignment=   11
         BevelWidth      =   0
         PictureDisabledFrames=   1
         PictureDisabled =   "PAID20.frx":21E3F
      End
   End
   ...
   Begin VB.Frame FRAME_CUR 
      ...
      Begin Threed.SSCommand cmdSave 
         ...
         PictureDisabledFrames=   1
         ShapeSize       =   1
         PictureDisabled =   "PAID20.frx":268E7
      End
      Begin Threed.SSCommand cmdUndo 
         ...
         PictureDisabledFrames=   1
         ShapeSize       =   1
         PictureDisabled =   "PAID20.frx":2B29B
      End
   End
