...
cString = "Select File1_60.Item ,File1_10.DescA,File1_10.[Group],File1_50.Desca as file1_50desca,Sum(File1_60.Quant) As SumOfQuant," & _
           " Sum((FILE1_60.QUANT) * (FILE1_60.COST))  AS SUMOFVALUE" & _
           " FROM ((( (File1_60H INNER JOIN FILE1_60 ON FILE1_60H.DOC_NO = FILE1_60.DOC_NO) inner join File1_10 on File1_60.item = file1_10.item) inner JOIN FILE1_50 ON FILE1_10.[GROUP] = FILE1_50.CODE)INNER JOIN FILE0_40 ON FILE1_60H.STORE1 = FILE0_40.CODE) INNER JOIN FILE0_40 AS FILE0_40_1 ON FILE1_60H.STORE2 = FILE0_40_1.CODE  "
...
cString = cString & " group by File1_60.item,File1_10.DescA,file1_50.DescA,FILE1_10.[GROUP]"
...
contemp.BeginTrans
contemp.CommitTrans
main.REPORT1.ReportFileName = App.Path & "\Reports\item4.rpt"
