...
If xMiss(0).Value = 1 Then
    cOr = "FILE1_11.DATE_BIRTH IS NULL"
    aHeader(0) = xMiss(0).Caption
End If

If xMiss(1).Value = 1 Then
    cOr = cOr & turn(cOr, " or ") & "FILE1_11.DATE_BEGIN IS NULL"
    aHeader(1) = xMiss(1).Caption
End If

If xMiss(2).Value = 1 Then
    cOr = cOr & turn(cOr, " or ") & "FILE1_11.GENDER IS NULL"
...
If ValidNum(xcode1.text) Then
    ...
    aHeader(3) = IIf(ValidNum(xCode2.text), BetweenString(xcode1.text, xCode2.text, "„‰ —ﬁ„ ⁄÷ÊÌ… : ", "Õ Ì —ﬁ„ ⁄÷ÊÌ… : "), "—ﬁ„ ⁄÷ÊÌ… :" & xcode1.text)
End If

If ValidNum(xCode2.text) Then
    cWhere = cWhere & turn(cWhere, " AND ") & " FILE1_10.code <= " & addvalue(xCode2.text)
    aHeader(3) = BetweenString(xcode1.text, xCode2.text, "„‰ —ﬁ„ ⁄÷ÊÌ… : ", "Õ Ì —ﬁ„ ⁄÷ÊÌ… : ")
End If
...
Else
    ...
    Report1.ReportFileName = sPath_App & "\REPORTS\REPORT16.rpt"
