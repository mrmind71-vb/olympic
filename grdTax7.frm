...
Begin VB.Form grdTax7 
   Caption         =   "ÓÏÇÏ ÝÑæÞ ÞíãÉ ãÖÇÝÉ ááÇÞÓÇØ"
   ClientHeight    =   10110
   ClientLeft      =   90
   ClientTop       =   465
   ClientWidth     =   20250
   ...
   Begin VB.Frame Frame2 
      ...
      Begin Threed.SSCommand cmdPrintLand 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "grdTax7.frx":7149
         Caption         =   "ØÈÇÚÉ"
         ButtonStyle     =   1
         PictureAlignment=   10
         BevelWidth      =   0
         PictureDisabledFrames=   1
         PictureDisabled =   "grdTax7.frx":A147
      End
   End
...
ToFileExel2 grid1, , , , , , , , aSplit, 14, , Me, myHeader
End Sub
...
LoadText Me
bNoCheck = False
If Not IsDate(xDate1.Text) Then xDate1.Text = myFormat_p(Date)
End Sub
Private Sub myload()
...
aPrm = AddFlag(aPrm, "date1", TurnValue(myFormat(xDate1.Text)))
aPrm = AddFlag(aPrm, "date2", TurnValue(myFormat(xDate2.Text)))

Set data10.Recordset = myCmdProc("dbo.sp_paid_late_install", con, aPrm)
End With
Fixgrd
Handlecontrols
End Sub
...
Dim nTotal_Sales As Double, nTotal_in As Double
    ...
    .TextMatrix(0, 2) = "ÊÇÑíÎ ÇáÇíÕÇá"
    .TextMatrix(0, 3) = "ÑÞã ÇáÚÖæíÉ"
    .TextMatrix(0, 4) = "ÇáÇÓã"
    .TextMatrix(0, 5) = "ÞíãÉ ÇáÇíÕÇá"
