   ...
   Begin VB.Frame Frame8 
      ...
      Begin Threed.SSCommand cmdLast 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "items.frx":E361
         Caption         =   "«ŒÌ—"
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "items.frx":10531
      End
      Begin Threed.SSCommand cmdNext 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "items.frx":12679
         Caption         =   "·«Õﬁ "
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "items.frx":14841
      End
      Begin Threed.SSCommand cmdPrevious 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "items.frx":16990
         Caption         =   "”«»ﬁ"
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "items.frx":18B70
      End
      Begin Threed.SSCommand cmdFirst 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "items.frx":1ACCB
         Caption         =   "√Ê·"
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "items.frx":1CE87
      End
   End
...
oFlagfrm.sTable = "FILE1_20G"
oFlagfrm.sCaption = "«·„Ã„Ê⁄…"
oFlagfrm.nZero = -1
oFlagfrm.bEdit = True
oFlagfrm.Show 1
Set DATA2.Recordset = myRecordSet("select * from FILE1_20G", con)
...
DATA1.RecordSource = "SELECT * FROM RELATION_CODES ORDER BY CODE"
Set xRelation.RowSource = DATA1
xRelation.ListField = "Desca"
xRelation.BoundColumn = "Code"

'data1.ConnectionString = strCon
'data2.RecordSource = "SELECT * FROM FILE1_20G ORDER BY CODE"
Set DATA2.Recordset = myRecordSet("SELECT * FROM FILE1_20G ORDER BY CODE", con)
...
If MsgBox("«·€«¡ «·”Ã· «·Õ«·Ï ø", vbOKCancel + vbDefaultButton2) = vbOK Then
    con.BeginTrans
    con.Execute "Delete  From FILE1_20  Where code = " & MyParn(xCode.Text)
    con.CommitTrans
    openCardTable
...
ItemsLookupAll Me, oSearch, cFilter
End Sub
...
cmdSave.Enabled = (nMode = LoadMode Or bopt1) And bEditRecord
...
xAge1.Text = CardTable!Age1 & ""
xAge2.Text = CardTable!Age2 & ""
...
aInsert = AddFlag(aInsert, "RELATION", addstring(xRelation.BoundText))
aInsert = AddFlag(aInsert, "AGE1", addvalue(xAge1.Text))
aInsert = AddFlag(aInsert, "AGE2", addvalue(xAge2.Text))
...
If xCode.Enabled Then
    xCode.Text = Val(Newflag("FILE1_20", "code"))
    aInsert = AddFlag(aInsert, "CODE", addstring(xCode.Text))
    con.Execute addInsert(aInsert, "FILE1_20")
Else
    con.Execute addUpdate(aInsert, "FILE1_20", "code = " & addstring(xCode.Text))
End If
con.CommitTrans
MyReplace = True
Exit Function
...
cFilter = ""
cString = "SELECT FILE1_20.* FROM FILE1_20"
If cFilter <> "" Then cString = cString & turn(cString) & cFilter
cString = cString & " ORDER BY FILE1_20.[CODE]"
