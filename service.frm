   ...
   Begin VB.Frame Frame8 
      ...
      Begin Threed.SSCommand cmdLast 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "service.frx":13988
         Caption         =   "«ŒÌ—"
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "service.frx":15B58
      End
      Begin Threed.SSCommand cmdNext 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "service.frx":17CA0
         Caption         =   "·«Õﬁ "
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "service.frx":19E68
      End
      Begin Threed.SSCommand cmdPrevious 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "service.frx":1BFB7
         Caption         =   "”«»ﬁ"
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "service.frx":1E197
      End
      Begin Threed.SSCommand cmdFirst 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "service.frx":202F2
         Caption         =   "√Ê·"
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "service.frx":224AE
      End
   End
...
End Sub
Sub mydefine()
xCode.Text = Newflag("FILE7_10", "code")
xDesca.Text = ""
xRelation.Text = ""
xPhone.Text = ""
xDegree.BoundText = ""
...
If validPhoto(RetPhoto_v(xCode.Text)) Then xMemberPhoto.Picture = LoadPicture(RetPhoto_v(xCode.Text))
End Sub
...
If xCode.Tag = DefineMode Then
    con.Execute addInsert(aInsert, "FILE7_10")
Else
    con.Execute addUpdate(aInsert, "FILE7_10", "FILE7_10.CODE = " & xCode.Text)
End If
con.CommitTrans
MyReplace = True
Exit Function
...
If MsgBox("«·€«¡ «·”Ã· «·Õ«·Ï : Â· «‰  „Ê«›ﬁ ø", vbOKCancel + vbDefaultButton2) = vbOK Then
    con.BeginTrans
    con.Execute "Delete  From FILE7_10 Where code = " & xCode.Text
    Dim fs As New FileSystemObject
    If fs.FileExists(RetPhoto_v(xCode.Text)) Then
        fs.DeleteFile RetPhoto_v(xCode.Text)
    End If
    con.CommitTrans
    openCardTable
...
ServiceLookupAll Me, oSearch, cFilter
End Sub
...
If MsgBox("Õ–› «·’Ê—… Â· «‰  „ √ﬂœ ?", vbOKCancel) = vbOK Then
    If fs.FileExists(RetPhoto_v(xCode.Text)) Then fs.DeleteFile RetPhoto_v(xCode.Text)
    imgx1.Images.Clear
    xMemberPhoto.Picture = LoadPicture("")
End If
Exit Sub
...
cString = "SELECT FILE7_10.* FROM FILE7_10 LEFT JOIN ENG_CODES ON FILE7_10.DEGREE = ENG_CODES.CODE"
If IsNumeric(sCode) Then cString = cString & turn(cString) & " CODE = " & sCode
cFilter = ""
If cFilter <> "" Then cString = cString & turn(cString) & cFilter
cString = cString & " ORDER BY  FILE7_10.code"
...
If Not ValidInt(xCode.Text) Then Exit Sub
ReplaceFromImage Image, RetPhoto_v(xCode.Text)
xMemberPhoto.Picture = LoadPicture(RetPhoto_v(xCode.Text))
End Sub
...
cString = "SELECT TOP 1 FILE7_40H.* FROM FILE7_40H  WHERE FILE7_40H.CODE = " & pMember & _
