...
Begin VB.Form gas_ordersfrm 
   ...
   Begin VB.Frame Frame6 
      ...
      Begin VB.CommandButton cmdDelFix 
         Height          =   510
         Left            =   45
         Picture         =   "gas_orders_incase.frx":0000
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   67
         ToolTipText     =   "⁄—÷"
      ...
      Begin VB.CommandButton cmdSave_fix 
         ...
         Left            =   1215
         MaskColor       =   &H00FFFFFF&
         Picture         =   "gas_orders_incase.frx":2424
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   62
         ToolTipText     =   "Õ›Ÿ"
   ...
   Begin VB.Frame Frame4 
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Left            =   3465
         MaskColor       =   &H00FFFFFF&
         Picture         =   "gas_orders_incase.frx":4787
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   11
         ToolTipText     =   "Õ›Ÿ"
      ...
      Begin VB.CommandButton CmdUndo 
         ...
         Left            =   2325
         MaskColor       =   &H00FFFFFF&
         Picture         =   "gas_orders_incase.frx":6AEA
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   18
         TabStop         =   0   'False
      ...
      Begin VB.CommandButton CmdExit 
         ...
         Left            =   45
         MaskColor       =   &H00FFFFFF&
         Picture         =   "gas_orders_incase.frx":9063
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   17
         TabStop         =   0   'False
      ...
      Begin VB.CommandButton CmdDel 
         ...
         Left            =   1185
         MaskColor       =   &H00FFFFFF&
         Picture         =   "gas_orders_incase.frx":B4CF
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   16
         TabStop         =   0   'False
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Left            =   4590
         MaskColor       =   &H00FFFFFF&
         Picture         =   "gas_orders_incase.frx":DD69
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   15
         TabStop         =   0   'False
      ...
      Begin VB.CommandButton CmdInform 
         ...
         Height          =   510
         Left            =   5760
         Picture         =   "gas_orders_incase.frx":10315
         Style           =   1  'Graphical
         TabIndex        =   14
         TabStop         =   0   'False
         ToolTipText     =   "«” ⁄·«„"
   ...
   Begin VB.Frame Frame8 
      ...
      Begin Threed.SSCommand cmdLast 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "gas_orders_incase.frx":12AE8
         Caption         =   "«ŒÌ—"
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "gas_orders_incase.frx":14CB8
      End
      Begin Threed.SSCommand cmdNext 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "gas_orders_incase.frx":16E00
         Caption         =   "·«Õﬁ "
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "gas_orders_incase.frx":18FC8
      End
      Begin Threed.SSCommand cmdPrevious 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "gas_orders_incase.frx":1B117
         Caption         =   "”«»ﬁ"
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "gas_orders_incase.frx":1D2F7
      End
      Begin Threed.SSCommand cmdFirst 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "gas_orders_incase.frx":1F452
         Caption         =   "√Ê·"
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "gas_orders_incase.frx":2160E
      End
   End
...
If xGas.MatchedWithList And xcar.MatchedWithList Then
    xDistance_car.Text = Int(Val(xQuant.Text) / Val(GetField("select gas1 from cars where code = " & MyParn(xcar.BoundText)) & ""))
...
cString = "select TOP 1 gas_orders.CODE, gas_orders.counter,gas_orders.date,gas_orders.distance_car from gas_orders"
cString = cString & turn(cString) & "car = " & MyParn(xcar.BoundText)
cString = cString & turn(cString) & "DATE <= " & DateSq(xDate.Text)
cString = cString & turn(cString) & "COUNTER < " & Val(xCounter.Text)
If xCode.Text <> "" Then cString = cString & turn(cString) & "GAS_ORDERS.CODE <> " & xCode.Text
