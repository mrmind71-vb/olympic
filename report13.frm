...
Dim aHeader(11)
cString = "Select file1_10.*,TYPE_CODES.DescA as TYPE_Desca,dbo.f_last_year_desca(file1_10.code) as year_desca " & _
...
Do Until sourcetable.EOF
    ...
    temptable!str5 = TurnValue(ArbString(sourcetable!year_desca & ""))
...
Else
    ...
    Report1.ReportFileName = sPath_App & "\REPORTS\REPORT13.rpt"
