...
Begin VB.Form chqClientfrm 
   ...
   Begin VB.Frame Frame8 
      ...
      Begin Threed.SSCommand cmdLast 
         ...
         PictureDisabled =   "ChqClient.frx":21D0
      End
      Begin Threed.SSCommand cmdNext 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "ChqClient.frx":4318
         Caption         =   "·«Õﬁ "
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "ChqClient.frx":64E0
      End
      Begin Threed.SSCommand cmdPrevious 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "ChqClient.frx":862F
         Caption         =   "”«»ﬁ"
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "ChqClient.frx":A80F
      End
      Begin Threed.SSCommand cmdFirst 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "ChqClient.frx":C96A
         Caption         =   "√Ê·"
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "ChqClient.frx":EB26
      End
   End
...
Generalarray(1) = " SELECT FILE5_20.SER_NO,CASE WHEN (NOT CODE1 IS NULL) THEN '«·⁄„Ì· : ' + FILE3_10.DESCA ELSE CASE WHEN (NOT CODE2 IS NULL) THEN '«·„Ê—œ : ' +  FILE4_10.DESCA ELSE [NAME] END END," & _
                  "CONVERT(VARCHAR(10),FILE5_20.DATE_1 ,111), CONVERT(VARCHAR(10),FILE5_20.DATE_r ,111), [VALUE] , CHK_ID, FILE5_20.TRANSNAME1 " & _
...
End Sub
Sub mydefine()
XSER_NO.Text = RetZero(Val(Newflag("FILE5_20", "ser_no")), 6)
XCHK_ID.Text = ""
xOld.Value = 0
xCode1.Text = ""
xCode2.Text = ""
...
If ActiveControl.Name = xCode1.Name Then
    ...
    xName1.Caption = oSearchClient.grid1.TextMatrix(oSearchClient.grid1.Row, 1)
...
ElseIf ActiveControl.Name = xCode2.Name Then
    ...
    xName2.Caption = oSearchSup.grid1.TextMatrix(oSearchSup.grid1.Row, 1)
    Unload oSearchSup
    SendKeys "{TAB}"
ElseIf ActiveControl.Name = xTransCode2.Name Then
    ActiveControl.Text = oSearchClient.grid1.TextMatrix(oSearchClient.grid1.Row, 0)
    xTransName2.Caption = oSearchClient.grid1.TextMatrix(oSearchClient.grid1.Row, 1)
    Unload oSearchClient
    xTransCode2_LostFocus
    On Error Resume Next
    cmdSave.SetFocus
    Err.Clear
    'SendKeys "{TAB}"
ElseIf ActiveControl.Name = xTransCode1.Name Then
    ActiveControl.Text = oSearchSup.grid1.TextMatrix(oSearchSup.grid1.Row, 0)
    xTransName1.Caption = oSearchSup.grid1.TextMatrix(oSearchSup.grid1.Row, 1)
    Unload oSearchSup
    xTransCode1_LostFocus
    On Error Resume Next
    cmdSave.SetFocus
    Err.Clear
Else
...
xDateBank.Text = Format(CardTable!DateBank, "YYYY-MM-DD")
...
xTransName1.Caption = CardTable!TRANSNAME1 & ""
xTransName2.Caption = CardTable!transname2 & ""
...
xName1.Caption = GetField("Select Desca from FILE3_10 where code = " & MyParn(xCode1.Text)) & ""
End Sub
...
xName2.Caption = GetDesca("Select Desca from FILE4_10 where code = " & MyParn(xCode2.Text))
End Sub
...
aInsert = AddFlag(aInsert, "DATEBANK", addDate(xDateBank.Text))
...
If xTransCode1.Text <> "" Then
    aInsert = AddFlag(aInsert, "[DESCATRANS]", addstring("«·„Ê—œ : " & xTransName1.Caption))
ElseIf xTransCode2.Text <> "" Then
    aInsert = AddFlag(aInsert, "[DESCATRANS]", addstring("«·⁄„Ì· : " & xTransName2.Caption))
Else
    aInsert = AddFlag(aInsert, "[DESCATRANS]", "NULL")
End If
aInsert = AddFlag(aInsert, "[CLOSED]", addstring(retClose))
aInsert = AddFlag(aInsert, "[TRANSCODE1]", addstring(xTransCode1.Text))
aInsert = AddFlag(aInsert, "[TRANSCODE2]", addstring(xTransCode2.Text))
...
Else
    con.Execute addUpdate(aInsert, "file5_20", "SER_NO = " & addstring(XSER_NO.Text))
End If
con.CommitTrans
myreplace = True
Exit Function
...
Next
End Sub
Private Sub xTransCode1_KeyUp(KeyCode As Integer, Shift As Integer)
If KeyCode = 112 Then SupLookupAll Me, oSearchSup
End Sub

Private Sub xTransCode1_LostFocus()
myLostFocus xTransCode1
xTransName1.Caption = ""
If Trim(xTransCode1.Text) <> "" Then
    xTransName1.Caption = GetField("Select Desca from file4_10 where code = " & MyParn(xTransCode1.Text))
    xTransCode2.Text = ""
...
End If
End Sub
Private Sub xTransCode2_KeyUp(KeyCode As Integer, Shift As Integer)
If KeyCode = 112 Then ClientLookupAll Me, oSearchClient
End Sub
Private Sub xTransCode2_LostFocus()
xTransName2.Caption = ""
myLostFocus xTransCode2
If Trim(xTransCode2.Text) <> "" Then
    xTransName2.Caption = GetField("Select Desca from file3_10 where code = " & MyParn(xTransCode2.Text)) & ""
    xTransCode1.Text = ""
