...
Dim aHeader(11)
cString = "Select file1_10.CODE ,FILE1_10.DESCA,FILE1_10.DATE_BEGIN,FILE1_10.SES_NO,FILE6_20H.DOC_NO,FILE6_20H.DATE,TYPE_CODES.DESCA AS TYPE_DESCA  " & _
...
cWhere = cWhere & turn(cWhere, " and ") & "FILE6_20H.DOC_NO = dbo.f_first_year_doc(FILE1_10.CODE) and FILE6_20H.TYPE = 9"
...
If IsNumeric(cmdYear(0).Tag) Then
    aHeader(1) = "«·Ãœœ Œ·«· „Ê”„ " & cmdYear(0).Caption
...
Do Until sourcetable.EOF
    ...
    temptable!str5 = TurnValue(ArbString(sourcetable!TYPE_desca & ""))
...
Else
    ...
    Report1.ReportFileName = sPath_App & "\REPORTS\REPORT25.rpt"
