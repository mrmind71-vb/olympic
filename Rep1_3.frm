...
cString = "Select File1_11.item as itemCode,File1_11.Doc_Id,FILE1_11.PRICE AS SumPrice," & _
          ...
          "From (File1_10 inner Join file1_11 on file1_10.item = File1_11.item) inner join file3_10 on file1_11.code = file3_10.code  WHERE (Type = '6' OR TYPE = '3' )  AND And File1_11.item = " & MyParn(xItem.Text)
...
cString = "Select File1_11.item as MidOfItem,File1_11.Doc_Id," & _
          ...
          "File4_10.DescA" & _
          " From (File1_10 inner Join file1_11 on file1_10.item = File1_11.item) inner join file4_10 on file1_11.code = file4_10.code WHERE Type = '2' AND And File1_11.item = " & MyParn(xItem.Text)
If IsDate(Date1.Text) Then cString = cString & " AND Date >= " & DateSql(Date1.Text)
If IsDate(date2.Text) Then cString = cString & " AND Date <= " & DateSql(date2.Text)
...
Private Sub XITEM_LostFocus()
    itemTable.FindFirst " ITEM =" & MyParn(xItem.Text)
    If Not itemTable.NoMatch Then xDesca.Text = itemTable.desca
End Sub
