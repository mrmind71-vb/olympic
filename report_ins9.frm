...
Begin VB.Form report_insfrm9 
   ...
   End
End
Attribute VB_Name = "report_insfrm9"
...
Dim aHeader(11)
cString = "SELECT  FILE6_21.DATE,FILE6_21.CODE,FILE2_10.DESCA,FILE6_21.VALUE,FILE6_21.DATE_PAID,FILE6_21.TAX + FILE6_21.TAX_DIFF,FILE6_21.VALUE +  FILE6_21.TAX +  FILE6_21.TAX_DIFF AS TOTAL,FILE2_10.PHONE" & _
          " FROM FILE6_21 ON FILE6_21.CODE = FILE2_10.CODE"
...
If IsDate(xDate_Begin2.Text) Then
    aHeader(1) = " «—ÌŒ »œ«Ì… «·⁄÷ÊÌ… „‰ " & BetweenString(myFormat_p(xdate_begin1.Text), myFormat_p(xDate_Begin2.Text))
    cWhere = cWhere & turn(cWhere, " and ") & "FILE2_10.DATE_BEGIN <= " & DateSq(xDate_Begin2.Text)
End If
...
Do Until sourcetable.EOF
    ...
    temptable!Str3 = sourcetable!Phone
...
Else
    contemp.BeginTrans
    contemp.CommitTrans
    Report1.ReportFileName = sPath_App & "\REPORTS\REPORT_INS9.rpt"
