...
Begin VB.Form grdpaid_sv2 
   Caption         =   "ÅÌãÇáí ÈäæÏ ÓÏÇÏ ãÑßÒ ÎÏãÇÊ"
   ClientHeight    =   10110
   ClientLeft      =   90
   ClientTop       =   465
   ClientWidth     =   16785
...
cString = "SELECT ENG_CODES.DESCA  ,FILE7_20.CODE,FILE7_20.DESCA,SUM(FILE7_40.QUANT),SUM(FILE7_40.VALUE)" & _
          "  FROM FILE7_40H INNER JOIN FILE7_40 ON FILE7_40H.DOC_NO = FILE7_40.DOC_NO INNER JOIN FILE7_20 ON FILE7_40.CODE = FILE7_20.CODE INNER JOIN FILE7_10 ON FILE7_40H.CODE = FILE7_10.CODE INNER JOIN ENG_CODES ON FILE7_10.[DEGREE] = ENG_CODES.CODE"
...
cString = cString & " GROUP BY FILE7_20.CODE,FILE7_20.DESCA,ENG_CODES.DESCA,ENG_CODES.CODE Order by ENG_CODES.CODE,FILE7_20.CODE"
