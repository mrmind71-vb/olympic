...
Dim oSearchClient As New Search3, cList As String
Dim CardTable As New ADODB.Recordset
Dim con As New ADODB.Connection
Private Sub myload()
On Error GoTo myerror
cString = "SELECT NOTES_CODES.CODE as [«·ﬂÊœ],NOTES_CODES.DESCA as [—ﬁ„ «·œ› —],NOTES_CODES.BON AS [«Ê· »Ê‰],NOTES_CODES.BON_COUNT AS [⁄œœ «·»Ê‰« ],NOTES_CODES.[KIND] AS [‰Ê⁄ «·»Ê‰]" & _
          " FROM NOTES_CODES"
...
If Trim(grid1.TextMatrix(Row, 4)) = "" Then Exit Function
validRow = True
End Function
...
If KeyCode = 13 And Col <> 4 Then CellPos KeyCode, Row, Col
End Sub
...
aInsert = AddFlag(aInsert, "[KIND]", addvalue(grid1.TextMatrix(Row, 4)))
con.BeginTrans
On Error GoTo myerror
