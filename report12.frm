...
If IsNumeric(cmdYear(0).Tag) Then
    aHeader(0) = "·„ Ì”œœ „Ê”„ " & cmdYear(0).Caption
...
Set loctable = myCmdText(cString, con)
Do Until loctable.EOF
    Me.Caption = Val(Me.Caption) + 1
    con.Execute "update file1_10 set file1_10.[drop] = 1 where code = " & loctable!code
    loctable.MoveNext
Loop
