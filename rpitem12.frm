...
cString = "SELECT Sum(FILE1_11.[IN] - FILE1_11.[out]) AS Balance,FILE1_10.ITEM,FILE1_10.DESCA, FILE1_10.[GROUP],FILE1_50.[GROUP] AS FILE1_50GROUP,FILE1_10.REORDER , FILE1_50.DESCA AS FILE1_50DESCA,FILE1_50G.DESCA AS FILE1_50GDESCA" & _
...
End If
cString = cString & " GROUP BY FILE1_10.REORDER , FILE1_10.ITEM, FILE1_10.DESCA, FILE1_10.[GROUP],FILE1_50.[GROUP],FILE1_10.COST, FILE1_50.DESCA,FILE1_50G.DESCA"
cString = cString & turn(cString, " HAVING ", " AND ") & " Sum(FILE1_11.[IN] -FILE1_11.[out]) <= FILE1_10.REORDER"
...
If temptable.EOF And temptable.BOF Then
    MsgBox "·«  ÊÃœ »Ì«‰«  ·ÿ»«⁄ Â«"
Else
    main.Report1.ReportFileName = App.Path & "\Reports\Item12.rpt"
    contemp.BeginTrans
    contemp.CommitTrans
