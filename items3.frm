   ...
   Begin VB.Frame Frame8 
      ...
      Begin Threed.SSCommand cmdLast 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "items3.frx":E361
         Caption         =   "«ŒÌ—"
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "items3.frx":10531
      End
      Begin Threed.SSCommand cmdNext 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "items3.frx":12679
         Caption         =   "·«Õﬁ "
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "items3.frx":14841
      End
      Begin Threed.SSCommand cmdPrevious 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "items3.frx":16990
         Caption         =   "”«»ﬁ"
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "items3.frx":18B70
      End
      Begin Threed.SSCommand cmdFirst 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "items3.frx":1ACCB
         Caption         =   "√Ê·"
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "items3.frx":1CE87
      End
   End
...
oFlagfrm.sTable = "FILE3_20G"
oFlagfrm.sCaption = "«·„Ã„Ê⁄…"
oFlagfrm.nZero = -1
oFlagfrm.bEdit = True
oFlagfrm.Show 1
Set DATA2.Recordset = myRecordSet("select * from FILE3_20G", con)
...
DATA1.RecordSource = "SELECT * FROM DEGREE_GROUP_CODES ORDER BY CODE"
...
Items_StudentLookupAll Me, oSearch, cFilter
End Sub
...
If xCode.Enabled Then
    xCode.Text = Val(Newflag("FILE3_20", "code"))
    aInsert = AddFlag(aInsert, "CODE", addstring(xCode.Text))
    con.Execute addInsert(aInsert, "FILE3_20")
Else
    con.Execute addUpdate(aInsert, "FILE3_20", "code = " & addstring(xCode.Text))
End If
con.CommitTrans
MyReplace = True
Exit Function
...
cFilter = ""
cString = "SELECT FILE3_20.* FROM FILE3_20"
If cFilter <> "" Then cString = cString & turn(cString) & cFilter
cString = cString & " ORDER BY FILE3_20.[CODE]"
