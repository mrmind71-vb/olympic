...
Begin VB.Form cash_sup 
   ...
   Begin VB.Frame Frame8 
      ...
      Begin Threed.SSCommand cmdLast 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "cash_sup2.frx":48DC
         Caption         =   "«ŒÌ—"
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "cash_sup2.frx":6AAC
      End
      Begin Threed.SSCommand cmdNext 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "cash_sup2.frx":8BF4
         Caption         =   "·«Õﬁ "
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "cash_sup2.frx":ADBC
      End
      Begin Threed.SSCommand cmdPrevious 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "cash_sup2.frx":CF0B
         Caption         =   "”«»ﬁ"
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "cash_sup2.frx":F0EB
      End
      Begin Threed.SSCommand cmdFirst 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "cash_sup2.frx":11246
         Caption         =   "√Ê·"
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "cash_sup2.frx":13402
      End
   End
   ...
   End
End
Attribute VB_Name = "cash_sup"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Public myPublic As Byte
Dim oSearchClient As New Search3, oSearchDoc As New Search3, oSearchTravel As New Search3
...
With grid1
    For i = IIf(Row = -1, 1, Row) To IIf(nRow = -1, grid1.Rows - 2, Row)
        ...
        aInsert = AddFlag(aInsert, "[TRAVEL]", addstring(grid1.TextMatrix(i, 5)))
        If grid1.TextMatrix(i, grid1.Cols - 1) = "" Then
            con.Execute addInsert(aInsert, "FILE8_20")
        Else
            con.Execute addUpdate(aInsert, "FILE8_20", "ID = " & grid1.TextMatrix(i, .Cols - 1))
        End If
    Next
End With
End Sub
...
If ActiveControl.Name = grid1.Name Then
    ...
    ElseIf grid1.Col = 5 Then
        grid1.TextMatrix(grid1.Row, 5) = oSearchTravel.grid1.TextMatrix(oSearchTravel.grid1.Row, 0)
        grid1.TextMatrix(grid1.Row, 6) = oSearchTravel.grid1.TextMatrix(oSearchTravel.grid1.Row, 1)
        grid1.TextMatrix(grid1.Row, 7) = oSearchTravel.grid1.TextMatrix(oSearchTravel.grid1.Row, 10)
        Grid1_AfterEdit grid1.Row, grid1.Col
        Unload oSearchTravel
        CellPos 13, grid1.Row, grid1.Col
    End If
...
bedit = True
openCon con
cStrBox = StrList("Select code,desca from file0_50 where code > '500'")
...
If Row = grid1.Rows - 1 Then
    MyAddItem
ElseIf Row = grid1.Rows - 2 And (.TextMatrix(Row, 3) <> "" And Col = 3) Then
...
If grid1.Col = 2 Or grid1.Col = 7 Or grid1.Col = 6 Or grid1.Col = 7 Or (grid1.Col = 5 And Trim(grid1.TextMatrix(grid1.Row, 1)) = "") Then grid1.Editable = flexEDNone Else grid1.Editable = flexEDKbdMouse
End Sub
...
With grid1
    cString = "SELECT FILE8_20.[BOX],FILE8_20.CODE,FILE4_10.DESCA,FILE8_20.desca, [VALUE],FILE8_20.TRAVEL,CONVERT(VARCHAR(10),TRAVEL_H.DATE,111),TRAVEL_H.DESCA,FILE8_20.ID" & _
               " FROM FILE8_20 INNER JOIN FILE4_10 ON FILE8_20.CODE = FILE4_10.CODE LEFT JOIN TRAVEL_H ON FILE8_20.TRAVEL = TRAVEL_H.DOC_NO"
    cString = cString & turn(cString) & "FILE8_20.Doc_no = " & MyParn(xDoc_No.Text)
...
ElseIf KeyCode = 112 Then
    If Trim(grid1.TextMatrix(grid1.Row, 1)) <> "" Then
        Travel_LookupAll Me, oSearchTravel, "TRAVEL_H.code_sup = " & MyParn(grid1.TextMatrix(grid1.Row, 1))
    End If
End If
End Sub
...
If Col = 1 Then
    ...
    Else
        ...
        aRet = GetFields("SELECT CODE,DESCA FROM FILE4_10 WHERE CODE = " & MyParn(grid1.EditText), con)
...
ElseIf Col = 5 Then
    ...
    Else
        grid1.EditText = RetZero(grid1.EditText)
        aRet = GetFields("SELECT CONVERT(VARCHAR(10),DATE,111) AS DATE,DESCA FROM TRAVEL_H WHERE DOC_NO = " & MyParn(grid1.EditText) & " AND CODE_SUP = " & MyParn(grid1.TextMatrix(grid1.Row, 1)), con)
        If IsEmpty(aRet) Then
           MsgBox "ﬂÊœ «·”›—Ì… €Ì— ’ÕÌÕ"
           Cancel = True
        Else
            grid1.TextMatrix(Row, 6) = retFlag(aRet, "DATE") & ""
...
Private Sub Fixgrd()
With grid1
    .FormatString = "Œ“‰…|" & "ﬂÊœ|" & "«·„Ê—œ|" & "«·»Ì«‰|" & "«·ﬁÌ„…|" & "«·”›—Ì…|" & "«· «—ÌŒ|" & "«·»Ì«‰|"
    .ColWidth(0) = 1800
    .ColWidth(1) = 1000
    .ColWidth(2) = 3000
    .ColWidth(3) = 3000
