...
Begin VB.Form purchase_chargefrm 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton CmdInform 
         Height          =   510
         Left            =   4140
         Picture         =   "purchare_charge.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   21
         TabStop         =   0   'False
         Top             =   135
      ...
      Begin VB.CommandButton cmdNewInv 
         ...
         Left            =   2775
         MaskColor       =   &H00FFFFFF&
         Picture         =   "purchare_charge.frx":27D3
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   20
         TabStop         =   0   'False
      ...
      Begin VB.CommandButton CmdDelInv 
         ...
         Left            =   1395
         MaskColor       =   &H00FFFFFF&
         Picture         =   "purchare_charge.frx":4D7F
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   19
         TabStop         =   0   'False
      ...
      Begin VB.CommandButton CmdExit 
         ...
         Left            =   45
         MaskColor       =   &H00FFFFFF&
         Picture         =   "purchare_charge.frx":7619
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   18
         TabStop         =   0   'False
   ...
   Begin VB.Frame Frame8 
      ...
      Begin Threed.SSCommand cmdLast 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "purchare_charge.frx":9A37
         Caption         =   "«ŒÌ—"
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "purchare_charge.frx":BC07
      End
      Begin Threed.SSCommand cmdNext 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "purchare_charge.frx":DD4F
         Caption         =   "·«Õﬁ "
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "purchare_charge.frx":FF17
      End
      Begin Threed.SSCommand cmdPrevious 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "purchare_charge.frx":12066
         Caption         =   "”«»ﬁ"
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "purchare_charge.frx":14246
      End
      Begin Threed.SSCommand cmdFirst 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "purchare_charge.frx":163A1
         Caption         =   "√Ê·"
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "purchare_charge.frx":1855D
      End
   End
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Left            =   45
         MaskColor       =   &H00FFFFFF&
         Picture         =   "purchare_charge.frx":1A6AC
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   5
         ToolTipText     =   "Õ›Ÿ"
      ...
      Begin VB.CommandButton CmdUndo 
         ...
         Left            =   45
         MaskColor       =   &H00FFFFFF&
         Picture         =   "purchare_charge.frx":1CA0F
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   8
         TabStop         =   0   'False
   ...
   End
End
Attribute VB_Name = "purchase_chargefrm"
...
With grid1
    cString = "SELECT " & cFile & ".[BOX], " & cFile & ".Charge," & DocClient & ".DESCA," & cFile & ".desca,[VALUE]," & cFile & ".CAR,CARS.BOARD, CARS.TYPE + ' ' + CARS.MODEL," & cFile & ".CODE,[ID] " & _
...
ElseIf Col = 5 Then
    ...
    ElseIf (Not ValidInt(grid1.EditText)) Then
        Cancel = True
    Else
        aRet = GetFields("SELECT BOARD,TYPE,MODEL FROM CARS WHERE CODE = " & grid1.EditText)
        If IsEmpty(aRet) Then
            MsgBox "ﬂÊœ «·”Ì«—… €Ì— ’ÕÌÕ"
            Cancel = True
        Else
            grid1.TextMatrix(grid1.Row, 6) = retFlag(aRet, "BOARD")
            grid1.TextMatrix(grid1.Row, 7) = retFlag(aRet, "TYPE") & " " & retFlag(aRet, "MODEL")
        End If
    End If
End If
End Sub
...
.FormatString = "Œ“‰…|" & "«·„’—Ê›|" & "Ê’› «·„’—Ê›|" & "«·»Ì«‰|" & "«·ﬁÌ„…|" & "«·”Ì«—…|" & "—ﬁ„ «··ÊÕ…|" & "«·»Ì«‰|" & "«·„”∆Ê·|"
.ColWidth(0) = 2000
.ColWidth(1) = 1000
.ColWidth(2) = 2900
.ColWidth(3) = 4000
...
If Col < grid1.Cols - 2 Then
    grid1.Col = Col + 1 + IIf(Col = 1, 1, 0) + IIf(Col = 5, 2, 0)
