...
Begin VB.Form reportfrm2 
   ...
   ScaleHeight     =   3765
   ScaleWidth      =   10080
   Begin VB.CheckBox chkBirthdate 
      Appearance      =   0  'Flat
      Caption         =   "ÿ»«⁄…  «—ÌŒ «·„Ì·«œ"
      BeginProperty Font 
         Name            =   "Arial"
...
.TextMatrix(0, 4) = "—ﬁ„ «· ·Ì›Ê‰"
.TextMatrix(0, 5) = IIf(chkBirthdate.Value = 1, " «—ÌŒ «·„Ì·«œ", " «—ÌŒ «·”œ«œ")
End With
...
Unload Me
End Sub
Private Function doprint(Optional bExcel As Boolean = False) As String
Dim aHeader(12)
If bExcel Then
    cString = "Select file1_10.CODE,FILE1_10.DESCA,FILE1_10.ADDRESS,FILE1_10.PHONE,FILE1_10.MOBIL, " & IIf(chkBirthdate.Value = 1, "FILE1_10.DATE_BIRTH", "dbo.f_last_year_date(FILE1_10.CODE)") & _
...
Do Until sourcetable.EOF
    ...
    If chkBirthdate.Value = 1 Then
        temptable!str6 = TurnValue(ArbStr(myFormat_p(sourcetable!DATE_BIRTH)))
        temptable!str7 = " «—ÌŒ «·„Ì·«œ"
    Else
        temptable!str6 = TurnValue(ArbStr(myFormat_p(sourcetable!DATE_LAST)))
        temptable!str7 = " «—ÌŒ «·”œ«œ"
    End If
