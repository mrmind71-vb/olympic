...
cString = "SELECT FILE8_70H.DATE, FILE8_70.DOC_NO, FILE8_71.DESCA AS DESCMAN , FILE8_70.DESCA, FILE8_70.VALUE_M, FILE8_70.VALUE_P FROM (FILE8_70 INNER JOIN FILE8_70H ON FILE8_70.DOC_NO = FILE8_70H.DOC_NO) INNER JOIN FILE8_71 ON FILE8_70.CODE = FILE8_71.CODE "
...
If xMan.BoundText <> "" Then
    cString = cString & turnFound(cString) & " FILE8_70.CODE = " & MyParn(xMan.BoundText)
    aHeader(2) = "[" & xMan.Text & "]"
End If
