...
Begin VB.Form Addresses_ifrm 
   ...
   End
End
Attribute VB_Name = "Addresses_ifrm"
...
For i = 1 To grid1.rows - 1
    ...
    con.Execute "update FILE2_10 set FILE2_10.region = " & addvalue(xRegion2.BoundText) & " where FILE2_10.code = " & addvalue(grid1.TextMatrix(i, 0))
Next
prog1.Value = 0
prog1.Visible = False
myloadgrd
...
cString = "select FILE2_10.Code,FILE2_10.Desca,region_codes.desca,FILE2_10.Address,FILE2_10.Phone,FILE2_10.Mobil from FILE2_10 left join region_codes on FILE2_10.region = region_codes.code where file2_10.status = 1"
If xPhone.Text <> "" Then cWhere = "FILE2_10.PHONE LIKE " & MyParn(xPhone.Text & "%")
If xAddress.Text <> "" Then
    If Check1.Value = 0 Then
        cWhere = cWhere & turn(cWhere, " and ") & MyParnAnd(xAddress.Text, "FILE2_10.ADDRESS")
    Else
        cWhere = cWhere & turn(cWhere, " and ") & "FILE2_10.ADDRESS LIKE " & MyParn("%" & xAddress.Text & "%")
    End If
End If
If xAddress2.Text <> "" Then
    cWhere = cWhere & turn(cWhere, " and ") & MyParnAndNo(xAddress2.Text, "FILE2_10.ADDRESS")
End If
If xRegion.BoundText <> "" Then cWhere = cWhere & turn(cWhere, " and ") & "FILE2_10.REGION = " & addvalue(xRegion.BoundText)
If xNoRegion = 1 Then cWhere = cWhere & turn(cWhere, " and ") & "FILE2_10.REGION IS NULL"
