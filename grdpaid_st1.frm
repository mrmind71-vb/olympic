...
cString = "SELECT '', FILE6_40H.DOC_NO,FILE6_40H.CODE,FILE3_10.DESCA,DEGREE_CODES.DESCA, CONVERT(VARCHAR(10),FILE6_40H.DATE,111),SUM(FILE6_40.VALUE),'' AS ITEMS_DESCA " & _
          "  FROM FILE6_40H INNER JOIN  FILE3_10 ON FILE6_40H.CODE = FILE3_10.CODE INNER JOIN FILE6_40 ON FILE6_40H.DOC_NO = FILE6_40.DOC_NO INNER JOIN DEGREE_CODES ON FILE3_10.DEGREE = DEGREE_CODES.CODE"
If ValidInt(xCode.Text) Then
    cString = cString & turn(cString) & "FILE6_40H.CODE = " & xCode.Text
...
If xGroup.MatchedWithList Then
    cString = cString & turn(cString) & "DEGREE_CODES.[GROUP] = " & xGroup.BoundText
...
cString = cString & " group by FILE6_40H.DOC_NO,FILE6_40H.CODE,FILE3_10.DESCA,FILE6_40H.DATE,DEGREE_CODES.DESCA Order by FILE6_40H.DOC_NO"
...
'    .ColDataType(4) = flexDTDouble
    ...
    For I = 2 To .rows - 1
        cString = "SELECT  FILE3_20.DESCA,count(*) AS countOf FROM   FILE6_40 INNER JOIN FILE3_20 ON FILE6_40.CODE = FILE3_20.CODE"
        cString = cString & turn(cString) & "FILE6_40.DOC_NO = " & MyParn(grid1.TextMatrix(I, 1))
        cString = cString & "GROUP BY FILE3_20.DESCA"
