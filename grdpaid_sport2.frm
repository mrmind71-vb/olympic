...
Begin VB.Form grdpaid_sport2 
   Caption         =   "ÅÌãÇáí ÓÏÇÏ ÈäæÏ  äÔÇØ ÕíÝí"
   ClientHeight    =   10110
   ClientLeft      =   90
   ClientTop       =   465
   ClientWidth     =   16785
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.CommandButton cmdGo 
         Height          =   555
         Left            =   3645
         Picture         =   "grdpaid_sport2.frx":0000
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   11
         ToolTipText     =   "ÚÑÖ"
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   555
         Left            =   2415
         Picture         =   "grdpaid_sport2.frx":3059
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   10
         Top             =   135
      ...
      Begin VB.CommandButton cmdExit 
         Height          =   555
         Left            =   45
         Picture         =   "grdpaid_sport2.frx":5483
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   9
         Top             =   135
      ...
      Begin VB.CommandButton cmdExel 
         Height          =   555
         Left            =   1215
         Picture         =   "grdpaid_sport2.frx":78EF
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   8
         ToolTipText     =   "ÚÑÖ"
   ...
   End
End
Attribute VB_Name = "grdpaid_sport2"
...
cString = "SELECT  FILE6_30.CODE, FILE1_30.DESCA, SUM(FILE6_30.QUANT),SUM(FILE6_30.TOTAL)" & _
          "  FROM FILE6_30H INNER JOIN FILE6_30 ON FILE6_30H.DOC_NO = FILE6_30.DOC_NO INNER JOIN FILE1_30 ON FILE6_30.CODE = FILE1_30.CODE"
...
If xGroup.MatchedWithList Then
    cString = cString & turn(cString) & "FILE1_30.[GROUP] = " & xGroup.BoundText
    aHeader(3) = "ÇáãÌãæÚÉ : " & xGroup.Text
End If

cString = cString & " group by FILE6_30.CODE, FILE1_30.DESCA ORDER BY FILE6_30.CODE"
