...
cString = "SELECT TOP 100 FILE8_50H.DOC_NO AS [—ﬁ„ «·„” ‰œ], FILE8_50.DESCA AS [«·»Ì«‰], FILE8_50.[VALUE] AS [«·ﬁÌ„…], CONVERT(VARCHAR(10),FILE8_50H.DATE,111) AS [«· «—ÌŒ],'' AS [«·„œ…]" & _
          "  FROM FILE8_50H INNER JOIN  FILE8_50 ON FILE8_50H.DOC_NO = FILE8_50.DOC_NO"
cString = cString & turn(cWhere) & cWhere
cString = cString & " ORDER BY FILE8_50H.DATE DESC,FILE8_50.ID DESC"
...
For i = 1 To grid1.Rows - 1
    nDays = DateDiff("d", Format(grid1.TextMatrix(i, 3), "yyyy-mm-dd"), sDate)
