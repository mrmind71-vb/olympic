...
Begin VB.Form report_insfrm6 
   ...
   End
End
Attribute VB_Name = "report_insfrm6"
...
Dim aHeader(11)
cString = "SELECT  FILE6_30H.DOC_NO,FILE6_30H.CODE,FILE2_10.DESCA,dbo.f_serial(FILE6_21.CODE,FILE6_21.DATE_DUE) as serial_no , FILE6_30H.DATE,FILE6_21.DATE_DUE, FILE6_30H.FORM_NO, FILE6_30.VALUE, FILE6_30.TAX + FILE6_30.TAX_DIFF AS TAX,FILE6_30.VALUE,FILE6_30.VALUE + FILE6_30.TAX + FILE6_30.TAX_DIFF AS TOTAL" & _
          " FROM FILE6_30H INNER JOIN FILE6_30 ON FILE6_30H.DOC_NO = FILE6_30.DOC_NO" & _
          " INNER JOIN FILE6_21 ON FILE6_30.LATE_ID = FILE6_21.ID " & _
...
If IsDate(xDate1.Text) Then
    aHeader(1) = " «—ÌŒ ”œ«œ „‰ " & BetweenString(myFormat_p(xDate1.Text), myFormat_p(xDate2.Text))
...
Do Until sourcetable.EOF
    ...
    temptable!Str4 = sourcetable!FORM_NO
    temptable!date1 = TurnValue(myFormat(sourcetable!Date))
    temptable!VAL3 = mRound(sourcetable!serial_no)
    temptable!val4 = mRound(sourcetable!Value)
    temptable!VAL5 = mRound(sourcetable!TAX)
    temptable!VAL6 = mRound(sourcetable!Value) + mRound(sourcetable!TAX)
...
Else
    ...
    contemp.CommitTrans
    If pReport = "" Then
        Report1.ReportFileName = sPath_App & "\REPORTS\REPORT_INS6.rpt"
    Else
