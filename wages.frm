   ...
   Begin VB.Frame Frame8 
      ...
      Begin Threed.SSCommand cmdLast 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "wages.frx":1073D
         Caption         =   "«ŒÌ—"
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "wages.frx":1290D
      End
      Begin Threed.SSCommand cmdNext 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "wages.frx":14A55
         Caption         =   "·«Õﬁ "
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "wages.frx":16C1D
      End
      Begin Threed.SSCommand cmdPrevious 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "wages.frx":18D6C
         Caption         =   "”«»ﬁ"
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "wages.frx":1AF4C
      End
      Begin Threed.SSCommand cmdFirst 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "wages.frx":1D0A7
         Caption         =   "√Ê·"
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "wages.frx":1F263
      End
   End
End
Attribute VB_Name = "wagesfrm"
...
ElseIf ActiveControl.Name = CmdInform.Name Then
    CardTable.Find "DOC_NO = " & Search.grid1.TextMatrix(Search.grid1.Row, 0), , adSearchForward, adBookmarkFirst
    Unload Search
...
With grid1
    cString = "SELECT empcode, emp.DESCA, salary.Base,Mot,Rw1,rw2,Rw3,Rw4, '' as Total,SALARY.INS,Dt,loan,'' as Plain,Notes,AUTOCODE" & _
          " FROM salary inner JOIN EMP ON SALARY.EMPCODE = EMP.CODE WHERE DOC_NO = " & xDoc_No.Text & " order by SALARY.ROW"
...
If IsNumeric(xMonth.Text) Then
    ...
    If IsNumeric(xYear.Text) Then
        If Val(xYear.Text) >= 2010 And Val(xYear.Text) <= 2030 Then
            cDoc_no = GetDesca("Select doc_no from salaryh where [YEAR] = " & xYear.Text & _
                " and [Month] = " & xMonth.Text)
            If cDoc_no <> "" Then
                CardTable.Find "doc_no = " & cDoc_no, , adSearchForward, adBookmarkFirst
                If CardTable.EOF Then
                    If Not CardTable.BOF Then CardTable.MoveLast Else Exit Sub
                End If
                myload
            End If
        End If
