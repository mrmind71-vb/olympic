   ...
   Begin VB.Frame Frame8 
      ...
      Begin Threed.SSCommand cmdLast 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "cash_sup1.frx":48DC
         Caption         =   "«ŒÌ—"
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "cash_sup1.frx":6AAC
      End
      Begin Threed.SSCommand cmdNext 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "cash_sup1.frx":8BF4
         Caption         =   "·«Õﬁ "
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "cash_sup1.frx":ADBC
      End
      Begin Threed.SSCommand cmdPrevious 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "cash_sup1.frx":CF0B
         Caption         =   "”«»ﬁ"
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "cash_sup1.frx":F0EB
      End
      Begin Threed.SSCommand cmdFirst 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "cash_sup1.frx":11246
         Caption         =   "√Ê·"
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "cash_sup1.frx":13402
      End
   End
...
cString = "SELECT " & cFileHeader & ".Doc_No, Convert(Varchar(10)," & cFileHeader & ".Date,111),Min(FILE3_10.Desca)" & _
          " FROM (" & cFileHeader & " inner join " & cFile & " on " & cFileHeader & ".doc_no = " & cFile & ".Doc_NO) Inner Join FILE3_10  on " & cFile & ".Code = FILE3_10.Code"
...
listarray(0, 0) = "«·«”„- «—ÌŒ «·„” ‰œ"
listarray(0, 1) = "(%%FILE3_10.Desca%% or " & _
                  " ##" & cFileHeader & ".Date##)"
...
If KeyCode = 13 Then
    If TypeOf ActiveControl Is TextBox Or TypeOf ActiveControl Is DBCombo Then
        SendKeys "{TAB}"
        KeyCode = 0
    End If
End If
...
If KeyCode = 112 And grid1.Col = 1 Then ClientLookupAll Me, oSearchClient
...
With grid1
    cString = "SELECT " & cFile & ".[BOX], " & cFile & ".CODE,FILE3_10.DESCA," & cFile & ".desca, [VALUE],ID " & _
               " FROM " & cFile & " INNER JOIN FILE3_10 ON " & cFile & ".CODE = FILE3_10.CODE "
...
ElseIf Row < grid1.Rows - 1 Then
    grid1.Select Row + 1, IIf(grid1.TextMatrix(Row + 1, 0) <> "", 1, 0)
