   ...
   Begin VB.Frame Frame8 
      ...
      Begin Threed.SSCommand cmdLast 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "emp_cash.frx":9A37
         Caption         =   "«ŒÌ—"
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "emp_cash.frx":BC07
      End
      Begin Threed.SSCommand cmdNext 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "emp_cash.frx":DD4F
         Caption         =   "·«Õﬁ "
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "emp_cash.frx":FF17
      End
      Begin Threed.SSCommand cmdPrevious 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "emp_cash.frx":12066
         Caption         =   "”«»ﬁ"
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "emp_cash.frx":14246
      End
      Begin Threed.SSCommand cmdFirst 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "emp_cash.frx":163A1
         Caption         =   "√Ê·"
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "emp_cash.frx":1855D
      End
   End
...
With grid1
    For i = IIf(Row = -1, 1, Row) To IIf(nRow = -1, grid1.Rows - 2, Row)
        ...
        aInsert = AddFlag(aInsert, "[VALUE_P]", Val(grid1.TextMatrix(i, 6)))
        aInsert = AddFlag(aInsert, "[VALUE_M]", Val(grid1.TextMatrix(i, 7)))
...
With grid1
    cString = "SELECT FILE8_90.[BOX],FILE8_90.CHARGE,FILE8_51.DESCA,FILE8_90.CODE,DRIVER.DESCA,FILE8_90.DESCA,CASE WHEN VALUE_P = 0 THEN NULL ELSE VALUE_P END,CASE WHEN VALUE_M = 0 THEN NULL ELSE VALUE_M END,FILE8_90.[ID] " & _
