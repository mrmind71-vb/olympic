   ...
   Begin VB.Frame Frame8 
      ...
      Begin Threed.SSCommand cmdLast 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "arrive4.frx":1073D
         Caption         =   "«ŒÌ—"
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "arrive4.frx":1290D
      End
      Begin Threed.SSCommand cmdNext 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "arrive4.frx":14A55
         Caption         =   "·«Õﬁ "
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "arrive4.frx":16C1D
      End
      Begin Threed.SSCommand cmdPrevious 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "arrive4.frx":18D6C
         Caption         =   "”«»ﬁ"
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "arrive4.frx":1AF4C
      End
      Begin Threed.SSCommand cmdFirst 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "arrive4.frx":1D0A7
         Caption         =   "√Ê·"
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "arrive4.frx":1F263
      End
   End
...
PrintGrdNew.doprint grid1, 1, -3, cHeader1, , , , False, True, 10
PrintGrdNew.Show 1
MyAddItem
End Sub
...
cString = cString & turn(cString) & "(Date_Begin <= " & DateSq(xDate.Text) & ")"
...
If Val(xYear.Text) < 2010 Or Val(xYear.Text) > 2030 Or Not IsNumeric(xYear.Text) Then
    ...
    Exit Function
End If
If Val(xWeek.Text) < 1 Or Val(xWeek) > 5 Then
...
If (Not ValidInt(xWeek.Text)) Then
    Cancel = True
ElseIf Not (xWeek.Text >= 1 And xWeek.Text <= 5) Then
    MsgBox "«·«”»Ê⁄ ·« Ì’·Õ"
    Cancel = True
Else
    LoadData
...
cString = cString & " Order by FILE2_50H.[YEAR],[MONTH],[WEEK]"
...
If Col < grid1.Cols - 2 Then
    If grid1.Col < 4 Then
        grid1.Col = 4
    Else
        grid1.Col = Col + 1 + IIf(Col = 4, 1, 0) + IIf(Col = 1, 2, 0) + IIf(Col = 8, 3, 0)
    End If
