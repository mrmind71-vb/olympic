...
Begin VB.Form grdTax8 
   Caption         =   "ÊÝÕíáí ÝÑæÞ ÞíãÉ ãÖÇÝÉ ÛíÑ ãÓÌáÉ"
   ClientHeight    =   10110
   ClientLeft      =   90
   ClientTop       =   465
   ClientWidth     =   20250
   ...
   Begin VB.Frame Frame2 
      ...
      Begin Threed.SSCommand cmdPrintLand 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "grdTax8.frx":7149
         Caption         =   "ØÈÇÚÉ"
         ButtonStyle     =   1
         PictureAlignment=   10
         BevelWidth      =   0
         PictureDisabledFrames=   1
         PictureDisabled =   "grdTax8.frx":A147
      End
   End
...
aPrm = AddFlag(aPrm, "date", TurnValue(myFormat(xDate1.text)))

Set data10.Recordset = myCmdProc("dbo.sp_member_late_unpaid", con, aPrm)
End With
Fixgrd
Handlecontrols
End Sub
...
Dim nTotal_Sales As Double, nTotal_in As Double
    ...
    .TextMatrix(0, 2) = "ÅÓã ÇáÚÖæ"
    .TextMatrix(0, 3) = "ÇáÖÑíÈÉ"
    .TextMatrix(0, 4) = "ÛÑÇãÉ"
    .TextMatrix(0, 5) = "ÅÌãÇáí ÇáÖÑíÈÉ"
