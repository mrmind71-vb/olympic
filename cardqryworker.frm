...
Begin VB.Form cardqryworkerfrm 
   Caption         =   "ÿ»«⁄… ﬂ«—‰ÌÂ«  «·⁄«„·Ì‰ »«·‰«œÌ"
   ClientHeight    =   10230
   ClientLeft      =   120
   ClientTop       =   450
   ...
   Begin VB.Frame Frame4 
      ...
      Begin VB.CommandButton CmdExit 
         ...
         Left            =   45
         MaskColor       =   &H00FFFFFF&
         Picture         =   "cardqryworker.frx":0000
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   18
         TabStop         =   0   'False
      ...
      Begin VB.CommandButton CmdDel 
         ...
         Left            =   1260
         MaskColor       =   &H00FFFFFF&
         Picture         =   "cardqryworker.frx":246C
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   17
         TabStop         =   0   'False
   ...
   Begin VB.Frame Frame5 
      ...
      Begin VB.CommandButton cmdExel 
         Height          =   555
         Left            =   45
         Picture         =   "cardqryworker.frx":4D06
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   40
         ToolTipText     =   "⁄—÷"
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   555
         Left            =   3420
         Picture         =   "cardqryworker.frx":74F1
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   10
         Top             =   180
      ...
      Begin Threed.SSCommand cmdAdd 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "cardqryworker.frx":991B
         Caption         =   "√÷«›… "
         Alignment       =   4
      End
      Begin Threed.SSCommand cmdprintrep 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "cardqryworker.frx":C984
         Caption         =   "ÿ»«⁄…  ﬁ—Ì—"
         Alignment       =   4
         PictureAlignment=   9
      End
   ...
   Begin VSFlex7Ctl.VSFlexGrid grid1 
      Bindings        =   "cardqryworker.frx":EF88
      Height          =   6360
      Left            =   90
      TabIndex        =   39
      Top             =   1710
   ...
   End
End
Attribute VB_Name = "cardqryworkerfrm"
...
For i = 1 To grid1.rows - 1
    If Not validPhoto(RetPhotow(grid1.TextMatrix(i, 2))) Then
...
Dim i As Long
For i = 1 To grid1.rows - 1
    If Not validPhoto(RetPhotow(grid1.TextMatrix(i, 0))) Then
        grid1.RowHidden(i) = True
    End If
Next
grid1.ColHidden(grid1.Cols - 1) = True
PrintGrdNew.doprint grid1, 0.8, -3, "ÿ»«⁄… «·›Œ—ÌÌ‰", , , , False, False, 9
PrintGrdNew.Show 1
...
cFilesave = TempSave(Me, , "grd")
'cFileSave2 = TempSave(Me, "printed", "grd")
Fixgrd
LoadText Me
...
If KeyAscii = 13 Then
    ...
    If Val(unMyCodeBar(xCode.Text, "8")) <> 8 Then
...
For i = 1 To .rows - 1
   If validPhoto(RetPhotow(grid1.TextMatrix(i, 0))) And (Val(grid1.TextMatrix(i, grid1.Cols - 1)) <> 0) Then
        ...
        aInsert = AddFlag(aInsert, "TITLE", addstring(grid1.TextMatrix(i, 2)))
        aInsert = AddFlag(aInsert, "JOB", addstring(grid1.TextMatrix(i, 4)))
        aInsert = AddFlag(aInsert, "TYPE", addvalue(grid1.TextMatrix(i, 6)))
        aInsert = AddFlag(aInsert, "DESCA_TYPE", addstring(grid1.TextMatrix(i, 6)))
        aInsert = AddFlag(aInsert, "[YEAR]", Val(xSeason.Text))
        con.Execute addInsert(aInsert, "FILE4_80")
        aInsert = AddFlag(Empty, "DATE_PRINT", addDate(Format(Date, "YYYY-MM-DD HH:NN")))
        con.Execute addUpdate(aInsert, "FILE8_10", "FILE8_10.CODE = " & grid1.TextMatrix(i, 0))
    End If
Next
con.CommitTrans
End With
...
Dim nRowItem As Integer
SettingArray(cUpMargin) = MyMeasure(1) + MyMeasure(Val(xDown.Text) / 10)
SettingArray(cRightMargin) = MyMeasure(0.9) + MyMeasure(Val(xRight.Text) / 10)
...
For i = 1 To grid1.rows - 1
    If validPhoto(RetPhotow(grid1.TextMatrix(i, 0))) And (Val(grid1.TextMatrix(i, grid1.Cols - 1)) <> 0) Then
        ...
        nspace = 0.8
        nspaceFixed = 0.7
        nspace = nspace + IIf(grid1.TextMatrix(i, 3) = "", 0.2, 0)
        nspace = nspace + IIf(grid1.TextMatrix(i, 4) = "", 0.2, 0)
        ...
        For i2 = 1 To 10
            ...
            tCard!Top = MyMeasure(4.5) - MyMeasure(0.4) - MyMeasure(nDiffer)
        ...
        tCard.AddNew
        tCard!Right = MyMeasure(0.5) + MyMeasure(0.6)
        ...
        tCard!fontsize = 10
        tCard!Text = "«·«”„ : " & grid1.TextMatrix(i, 1)
...
'        tCard.Update
        ...
        If grid1.TextMatrix(i, 4) <> "" Then
            nRowItem = nRowItem + 1
            tCard!Right = MyMeasure(0.5) + MyMeasure(0.1) + MyMeasure(0.8)
            tCard!Top = MyMeasure(0) + MyMeasure(nspace * nRowItem)
            tCard!Width = MyMeasure(8)
            tCard!Height = 0
            tCard!FontName = "Arial"
            tCard!FontBold = True
            tCard!ForeColor = vbBlack
            tCard!fontsize = 10
            tCard!Text = TurnValue("«·ÊŸÌ›… : " & grid1.TextMatrix(i, 4))
            tCard!TextAlign = taRightTop
            tCard!CardNo = nCard
            tCard.Update
        End If
    ...
    '        —ﬁ„ «·⁄÷ÊÌ…
            tCard.AddNew
            tCard!Right = MyMeasure(0.5) + MyMeasure(0.1) + MyMeasure(1.1)
            tCard!Top = MyMeasure(0) + MyMeasure(nspace * nRowItem)
            ...
            tCard!ForeColor = vbBlack
            tCard!fontsize = 10
            tCard!Text = ArbString("«·—ﬁ„ «·ﬁÊ„Ì : " & grid1.TextMatrix(i, 3))
            tCard!TextAlign = taRightTop
            tCard!CardNo = nCard
            tCard.Update
        End If
        ...
        tCard!Top = MyMeasure(0) + MyMeasure(nspaceFixed * 4) + MyMeasure(0.2)
        tCard!Width = 0
        tCard!Height = 0
        tCard!FontName = "Arial"
        tCard!FontBold = True
        ...
        ' «·ﬂ«—‰ÌÂ ‘Œ’Ì
        tCard.AddNew
        tCard!Right = MyMeasure(2.6)
        tCard!Top = MyMeasure(0) + MyMeasure(nspaceFixed * 5)
        tCard!FontName = "Arial"
        tCard!FontBold = True
        ...
        tCard!Text = MyCodeBar(grid1.TextMatrix(i, 0), "8")
        tCard!TextAlign = taRightTop
        tCard!CardNo = nCard
        tCard.Update
...
' «·Ã“¡ «·«Ì”—
        ...
        '«·’Ê—… «·ﬂ»Ì—…
        tCard.AddNew
        tCard!Right = MyMeasure(6.5) - MyMeasure(0.2) + MyMeasure(0.05)
        tCard!Top = MyMeasure(0.8) - MyMeasure(nDiffer)
        tCard!Width = MyMeasure(2.4) * 0.8
        tCard!Height = MyMeasure(2.8) * 0.8
        tCard!Text = RetPhotow(grid1.TextMatrix(i, 0))
        tCard!isPhoto = True
        tCard!CardNo = nCard
        tCard.Update
...
'        '«· ÊﬁÌ⁄
        ...
        tCard!Top = MyMeasure(3.6) - MyMeasure(0.2) - MyMeasure(nDiffer)
        ...
        tCard!Top = MyMeasure(3.2) - MyMeasure(0.1) - MyMeasure(nDiffer)
...
For i = 1 To grid1.rows - 1
    ...
    If Not validPhoto(RetPhotow(grid1.TextMatrix(i, 0))) Then grid1.Cell(flexcpForeColor, i, 0, i, .Cols - 1) = vbRed
    aPrint = Printed_w(.TextMatrix(i, 0), xSeason.Text, con)
    grid1.TextMatrix(i, 5) = Format(retFlag(aPrint, "date"), "yyyy/mm/dd")
    If IsDate(grid1.TextMatrix(i, 5)) Then .Cell(flexcpBackColor, i, 0, i, .Cols - 1) = &HE0E0E0
Next
prog1.Visible = False
End With
End Sub
...
cString = "SELECT FILE8_10.*,NULL AS SHARE_DESCA FROM FILE8_10"

'If xShare.MatchedWithList Then
'    cString = cString & turn(cString) & "FILE8_10.SHARE = " & xShare.BoundText
'End If
If ValidInt(xCode1.Text) Then
    cString = cString & turn(cString) & " FILE8_10.CODE  " & IIf(IsNumeric(xCode2.Text), " >= ", " = ") & xCode1.Text
End If

If ValidInt(xCode2.Text) Then
    cString = cString & turn(cString) & " FILE8_10.CODE <= " & xCode2.Text
End If

cString = cString & " ORDER BY FILE8_10.DESCA"
...
Do Until GRDTABLE.EOF
    ...
    aPrint = Printed_w(GRDTABLE!CODE, xSeason.Text, con)
    ...
    If bAddRow Then
        ...
        .TextMatrix(grid1.rows - 1, 2) = "»Ì«‰«  ÊŸÌ›Ì…"
        .TextMatrix(grid1.rows - 1, 3) = GRDTABLE!Title & ""
        .TextMatrix(grid1.rows - 1, 4) = GRDTABLE!job & ""
        .TextMatrix(grid1.rows - 1, 5) = myFormat_p(retFlag(aPrint, "Date"))
        
        If xPrinted.Value = 1 And (Not IsEmpty(aPrint)) Then
            .TextMatrix(grid1.rows - 1, 6) = retFlag(aDamageOnly, "CODE")
            .TextMatrix(grid1.rows - 1, 7) = retFlag(aDamageOnly, "DESCA")
        ElseIf xPrinted.Value = 0 Then
            .TextMatrix(grid1.rows - 1, 6) = retFlag(aDamageOnly, "CODE")
            .TextMatrix(grid1.rows - 1, 7) = retFlag(aDamageOnly, "DESCA")
        End If
        '.TextMatrix(grid1.rows - 1, 8) = GRDTABLE!SHARE_DESCA & ""
    End If
    GRDTABLE.MoveNext
Loop
GRDTABLE.Close
...
With grid1
    ...
    .TextMatrix(0, 1) = "«·«”„"
    .TextMatrix(0, 2) = "‰Ê⁄ «·⁄÷ÊÌ…"
    .TextMatrix(0, 3) = "«·—ﬁ„ «·ﬁÊ„Ì"
    .TextMatrix(0, 4) = "«·ÊŸÌ›…"
    .TextMatrix(0, 5) = " «—ÌŒ «Œ— ÿ»«⁄…"
    .TextMatrix(0, 6) = "‰Ê⁄ «·ﬂ«—‰ÌÂ"
...
For i = 0 To grid1.rows - 1
    nAll = nAll + 1
    If validPhoto(RetPhotow(grid1.TextMatrix(i, 2))) Then nphoto = nphoto + 1
Next
...
Dim aret As Variant
aret = GetFields("select DESCA from FILE8_10 where code = " & xCode1.Text)
