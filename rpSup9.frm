...
If Trim(xCode.Text) <> "" Then
    cwhere = cwhere & turnFound(cwhere) & " FILE7_30h.code = " & MyParn(xCode.Text)
...
cField1 = "(Select Sum(FILE7_30.Quant * FILE7_30.Price) " & _
          " from (FILE7_30 inner join FILE7_30h on FILE7_30.doc_no = FILE7_30h.doc_no) left join file4_10 on FILE7_30h.code = file4_10.code " & _
          turnFound(cwhere) & _
          cwhere & ") as sumoftotal"
          
cField2 = "(Select Sum(Discount) " & _
          " from FILE7_30h  left join file4_10 on FILE7_30h.code = file4_10.code " & _
          turnFound(cwhere) & _
...
cString = "SELECT FILE7_30H.DOC_NO, FILE7_30H.DATE, FILE7_30H.CODE, FILE0_40.DESCA, FILE7_30.ITEM, FILE1_10.DESCA, FILE7_30.PRICE, FILE7_30.QUANT,FILE7_30H.tax, FILE7_30H.discount, file4_10.DESCA, " & _
          cField1 & "," & cField2 & "," & cField3 & _
          " FROM (((FILE7_30 INNER JOIN FILE7_30H ON FILE7_30.DOC_NO = FILE7_30H.DOC_NO) LEFT JOIN FILE0_40 ON FILE7_30H.store = FILE0_40.CODE) LEFT JOIN FILE1_10 ON FILE7_30.ITEM = FILE1_10.ITEM) LEFT JOIN file4_10 ON FILE7_30H.code = file4_10.CODE"
...
Do Until sourcetable.EOF
        ...
        temptable!str2 = sourcetable![FILE4_10.DESCA]
        temptable!Str3 = sourcetable![FILE0_40.DESCA]
        temptable!Date1 = sourcetable!Date
        temptable!str4 = sourcetable!Item
        temptable!str5 = sourcetable![FILE1_10.DESCA]
...
contemp.BeginTrans
contemp.CommitTrans
main.REPORT1.ReportFileName = App.Path & "\Reports\Sup9.rpt"
