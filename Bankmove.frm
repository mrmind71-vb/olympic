...
cString = "Select * from BankMove Where BANK = " & MyParn(xBank.BoundText)
...
cString = cString & " Order by [Date],VALUE1,VALUE2"
...
cHeader1 = " ›’Ì·Ì Õ—ﬂ… »‰ﬂ " & xBank.Text & "  Œ·«· › —…"
...
grid1.FormatString = " «—ÌŒ |" & "—ﬁ„ «·„” ‰œ|" & "‰Ê⁄ |" & "»Ì«‰ |" & "«Ìœ«⁄« |" & "„”ÕÊ»« |" & "—’Ìœ"
grid1.Cols = 7
