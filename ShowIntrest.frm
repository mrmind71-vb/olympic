...
Begin VB.Form ShowInterestfrm 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin Threed.SSCommand cmdPrint 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "ShowIntrest.frx":2323
         ButtonStyle     =   3
         PictureAlignment=   11
         BevelWidth      =   0
         PictureDisabledFrames=   1
         PictureDisabled =   "ShowIntrest.frx":4699
      End
   End
   ...
   End
End
Attribute VB_Name = "ShowInterestfrm"
...
.RowHeight(0) = 800
.WordWrap = True
.FormatString = " «—ÌŒ «·«Ì’«·|" & " «—ÌŒ «·«” Õﬁ«ﬁ|" & "«·”‰…|" & "„‰  «—ÌŒ|" & "Õ Ì  «—ÌŒ|" & "⁄œœ «·‘ÂÊ—|" & "‰”»… «·›«∆œ…|" & "ﬁÌ„… «·ﬁ”ÿ|" & "«·›«∆œ…"
.ColWidth(0) = 1300
.ColWidth(1) = 1300
.ColWidth(2) = 1000
.ColWidth(3) = 1350
...
If .rows > 1 Then
    ...
    .Subtotal flexSTSum, -1, 8, "#0.00", &HC0FFC0, vbBlack, True, "  "
    .TextMatrix(.rows - 1, 0) = "«·≈Ã„«·Ï"
    FixTotals grid1, .rows - 1, Array(5, 6, 8)
End If
End With
End Sub
Private Sub myload()
...
Dim aPrm As Variant
aPrm = AddFlag(aPrm, "date", myFormat_sp(pDate))
aPrm = AddFlag(aPrm, "id", addvalue(pId))

Set DATA1.Recordset = myCmdProc("dbo.sp_interest_year", con, aPrm)
Fixgrd
grid1.Select grid1.rows - 1, 1
grid1.ShowCell grid1.rows - 1, 1
aHeader(0) = ArbString("›«∆œ… ⁄·Ì «·«ﬁ”«ÿ «·„ √Œ—… : " & xDesca.Caption & "  (" & pCode & ")")
aHeader(1) = "» «—ÌŒ : " & myFormat_p(xdate.Caption)
End Sub
Private Sub Form_Unload(Cancel As Integer)
closeCon con
Set ShiowInterestfrm = Nothing
End Sub
