...
cString = "Select INV_TOTAL.STORE,FILE0_40.DESCA,SUM(TOTAL) - SUM(DISCOUNT)  AS SUMOFTOTAL, SUM(COST) AS SUMOFCOST " & _
         " From  INV_TOTAL INNER JOIN FILE0_40 ON INV_TOTAL.STORE = FILE0_40.CODE "
...
cString = cString & " GROUP BY INV_TOTAL.STORE,FILE0_40.DESCA"
