...
Begin VB.Form oil_ordersfrm 
   ...
   Begin VB.Frame Frame4 
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Left            =   3465
         MaskColor       =   &H00FFFFFF&
         Picture         =   "oil_orders_incase.frx":0000
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   11
         ToolTipText     =   "Õ›Ÿ"
      ...
      Begin VB.CommandButton CmdUndo 
         ...
         Left            =   2325
         MaskColor       =   &H00FFFFFF&
         Picture         =   "oil_orders_incase.frx":2363
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   18
         TabStop         =   0   'False
      ...
      Begin VB.CommandButton CmdExit 
         ...
         Left            =   45
         MaskColor       =   &H00FFFFFF&
         Picture         =   "oil_orders_incase.frx":48DC
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   17
         TabStop         =   0   'False
      ...
      Begin VB.CommandButton CmdDel 
         ...
         Left            =   1185
         MaskColor       =   &H00FFFFFF&
         Picture         =   "oil_orders_incase.frx":6D48
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   16
         TabStop         =   0   'False
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Left            =   4590
         MaskColor       =   &H00FFFFFF&
         Picture         =   "oil_orders_incase.frx":95E2
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   15
         TabStop         =   0   'False
      ...
      Begin VB.CommandButton CmdInform 
         ...
         Height          =   510
         Left            =   5760
         Picture         =   "oil_orders_incase.frx":BB8E
         Style           =   1  'Graphical
         TabIndex        =   14
         TabStop         =   0   'False
         ToolTipText     =   "«” ⁄·«„"
   ...
   Begin VB.Frame Frame8 
      ...
      Begin Threed.SSCommand cmdLast 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "oil_orders_incase.frx":E361
         Caption         =   "«ŒÌ—"
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "oil_orders_incase.frx":10531
      End
      Begin Threed.SSCommand cmdNext 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "oil_orders_incase.frx":12679
         Caption         =   "·«Õﬁ "
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "oil_orders_incase.frx":14841
      End
      Begin Threed.SSCommand cmdPrevious 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "oil_orders_incase.frx":16990
         Caption         =   "”«»ﬁ"
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "oil_orders_incase.frx":18B70
      End
      Begin Threed.SSCommand cmdFirst 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "oil_orders_incase.frx":1ACCB
         Caption         =   "√Ê·"
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "oil_orders_incase.frx":1CE87
      End
   End
...
If Not ValidInt(xBon.Caption) Then
    ...
    Exit Function
End If
If IsEmpty(GetField("select code from notes_codes_oil where BON <= " & xBon.Caption & " AND BON + BON_COUNT >= " & xBon.Caption)) Then
...
Dim aKind As Variant
If xGas2.MatchedWithList Then
    aKind = GetFields("select price from type_gas_codes where code = " & xGas2.BoundText)
    xPrice2.Text = Val(retFlag(aKind, "price"))
Else
    xPrice2.Text = ""
End If
End Sub
