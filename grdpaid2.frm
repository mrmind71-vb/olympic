...
Begin VB.Form grdpaid2 
   Caption         =   "ÅÌãÇáí ÈäæÏ ÇáÓÏÇÏ"
   ClientHeight    =   10110
   ClientLeft      =   90
   ClientTop       =   465
   ClientWidth     =   16785
...
cString = "SELECT FILE6_10G.CODE,FILE6_10G.DESCA,SUM(FILE6_20.QUANT),SUM(FILE6_20.TOTAL_ITEM),SUM(FILE6_20.DISCOUNT),SUM(FILE6_20.TOTAL_DISCOUNT),SUM(FILE6_20.TAX),SUM(FILE6_20.TOTAL)" & _
...
If xGroup.MatchedWithList Then
    ...
    aHeader(1) = "ÇáãÌãæÚÉ : " & xGroup.Text
End If
...
cString = cString & " GROUP BY FILE6_10G.CODE,FILE6_10G.DESCA Order by FILE6_10G.CODE,FILE6_10G.DESCA"
...
Dim nTotal_Sales As Double, nTotal_in As Double
    ...
    .TextMatrix(0, 1) = "ÇáãÌãæÚÉ"
    .TextMatrix(0, 2) = "ÇáÚÏÏ"
    .TextMatrix(0, 3) = "ÇáÞíãÉ"
    .TextMatrix(0, 4) = "ÇáÎÕã"
    .TextMatrix(0, 5) = "ÕÇÝí  ÇáÞíãÉ"
    .TextMatrix(0, 6) = "ÇÌãÇáí ÇáÖÑíÈÉ"
    .TextMatrix(0, 7) = "ÇáÅÌãÇáí"
