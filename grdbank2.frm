...
grid1.Rows = 1
cString = "SELECT   ORDERS.CODE, ORDERS.DATE, ORDERS.COUNTER_OUT, ORDERS.TIME_OUT, ORDERS.COUNTER_IN, ORDERS.TIME_IN, ORDERS.DISTANCE," & _
          "Driver.DESCA , Line" & _
          " FROM   ORDERS INNER JOIN DRIVER ON ORDERS.DRIVER = DRIVER.CODE"
cString = cString & turn(cString) & "ORDERS.Car = " & MyParn(xcar.BoundText)

If IsDate(xDate1.Text) Then
    cString = cString & turn(cString) & "ORDERS.Date >= " & DateSq(xDate1.Text)
End If
          
If IsDate(xDate2.Text) Then
    cString = cString & turn(cString) & "ORDERS.Date <= " & DateSq(xDate2.Text)
End If
...
Dim nTotal_Sales As Double, nTotal_in As Double
    ...
    .TextMatrix(0, 0) = "«·ﬂÊœ"
    .TextMatrix(0, 1) = "«· «—ÌŒ"
    .TextMatrix(0, 2) = "⁄œ«œ «·Œ—ÊÕ"
    .TextMatrix(0, 3) = "„Ì⁄«œ «·Œ—ÊÃ"
    .TextMatrix(0, 4) = "⁄œ«œ «·⁄Êœ…"
    .TextMatrix(0, 5) = "„Ì⁄«œ «·⁄Êœ…"
    .TextMatrix(0, 6) = "«·„”«›…"
    .TextMatrix(0, 7) = "≈”„ «·”«∆ﬁ"
    .TextMatrix(0, 8) = "«·Œÿ"
