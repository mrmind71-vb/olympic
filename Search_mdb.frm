...
Begin VB.Form Search_mdb 
   ...
   End
End
Attribute VB_Name = "Search_mdb"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Dim Generalarray, listarray, GrdArray
Public nMax_records As Long, pMdbPath As String
...
If KeyCode = 13 And (bEnterwork Or xEnter.Value = 1) Then
    KeyCode = 0
...
If sId <> "" Then
    If ValidNum(RetSetting("left", TempSave(Me, sId))) Then
        Me.Left = RetSetting("left", TempSave(Me, sId))
    End If
    If ValidNum(RetSetting("top", TempSave(Me, sId))) Then
        Me.Top = RetSetting("top", TempSave(Me, sId))
    End If
End If
...
Ado1.ConnectionString = "Provider=Microsoft.Jet.OLEDB.4.0;Persist Security Info=False;Data Source=" & pMdbPath
...
For i = 1 To Len(FixDate)
    ...
    If IsDate(cSearch) Then
        cString2 = cField & " " & pSign & " " & DateSq_mdb(cSearch)
    Else
        cString2 = "(FALSE)"
    End If
