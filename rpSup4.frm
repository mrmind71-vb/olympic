...
'cString = "SELECT FILE7_20H.DOC_NO, FILE7_20H.DATE, SUM(VAL(FILE7_20.QUANT & '') * VAL(FILE7_20.PRICE & '')) - VAL(FILE7_20H.DISCOUNT & '') + VAL(FILE7_20H.TAX) As Total,FILE7_20H.CODE,FILE4_10.DESCA,FILE4_10.[GROUP],FILE4_50.DESCA AS GROUPDESCA" & _
...
If Trim(xCode.Text) <> "" Then cwhere = cwhere & turn(cwhere, " AND ") & " FILE7_20H.CODE = " & MyParn(xCode.Text)
...
contemp.BeginTrans
contemp.CommitTrans
main.REPORT1.ReportFileName = App.Path & "\Reports\sup4" & IIf(chkCharge.Value = 1, "C", "") & IIf(Check1.Value = 1, "G", "") & ".RPT"
