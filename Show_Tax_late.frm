...
Begin VB.Form ShowTaxLatefrm 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin Threed.SSCommand cmdExit 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "Show_Tax_late.frx":0000
         Alignment       =   8
         ButtonStyle     =   3
         PictureAlignment=   11
         BevelWidth      =   0
      ...
      Begin Threed.SSCommand cmdPrint 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "Show_Tax_late.frx":2323
         ButtonStyle     =   3
         PictureAlignment=   11
         BevelWidth      =   0
         PictureDisabledFrames=   1
         PictureDisabled =   "Show_Tax_late.frx":4699
      End
   End
   ...
   End
End
Attribute VB_Name = "ShowTaxLatefrm"
...
PrintGrdNew.doprint grid1, 1, -1, "", retHeader(aHeader, 0, 1, Space(6)), retHeader(aHeader, 1, 1, Space(6)), , False, False, 11, , aRow, Array(0, 1, 2)
PrintGrdNew.Show 1
...
.RowHeight(0) = 800
.WordWrap = True
.FormatString = "«·”‰…|" & "—ﬁ„ «·„” ‰œ|" & "«· «—ÌŒ|" & "«·»‰œ|" & "„ √Œ—«  «·÷—Ì»…|" & "⁄œœ «·‘ÂÊ—|" & "‰”»… «·€—«„…|" & "«·€—«„…|" & "≈Ã„«·Ì «·„ √Œ—« "
.ColWidth(0) = 1500
.ColWidth(1) = 1000
.ColWidth(2) = 1300
.ColWidth(3) = 3000
...
Set data1.Recordset = myCmdProc("dbo.pr_tax_dtl", con, aPrm)
Fixgrd
grid1.Select grid1.rows - 1, 1
grid1.ShowCell grid1.rows - 1, 1
aHeader(0) = ArbString("„ √Œ—«  ÷—Ì»… «·ﬁÌ„… «·„÷«›… ⁄·Ì «·⁄÷Ê : " & xdesca.Caption & "  (" & pCode & ")")
