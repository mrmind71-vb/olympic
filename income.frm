   ...
   Begin VB.Frame Frame8 
      ...
      Begin Threed.SSCommand cmdLast 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "income.frx":9A37
         Caption         =   "«ŒÌ—"
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "income.frx":BC07
      End
      Begin Threed.SSCommand cmdNext 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "income.frx":DD4F
         Caption         =   "·«Õﬁ "
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "income.frx":FF17
      End
      Begin Threed.SSCommand cmdPrevious 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "income.frx":12066
         Caption         =   "”«»ﬁ"
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "income.frx":14246
      End
      Begin Threed.SSCommand cmdFirst 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "income.frx":163A1
         Caption         =   "√Ê·"
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "income.frx":1855D
      End
   End
...
Dim oSearchDoc As New Search3, oSearchClient As New Search3, oSearchBox As New Search3
...
With grid1
    For i = IIf(Row = -1, 1, Row) To IIf(nRow = -1, grid1.Rows - 2, Row)
        ...
        aInsert = AddFlag(aInsert, "[CODE]", addstring(grid1.TextMatrix(i, 5)))
...
If ActiveControl.Name = grid1.Name Then
    ...
    ElseIf grid1.Col = 5 Then
        grid1.TextMatrix(grid1.Row, 5) = oSearchClient.grid1.TextMatrix(oSearchClient.grid1.Row, 0)
        grid1.TextMatrix(grid1.Row, 6) = oSearchClient.grid1.TextMatrix(oSearchClient.grid1.Row, 1)
        Unload oSearchClient
        Grid1_AfterEdit grid1.Row, grid1.Col
        CellPos 13, grid1.Row, grid1.Col
    End If
...
With grid1
    cString = "SELECT " & cFile & ".[BOX], " & cFile & ".Charge," & DocClient & ".DESCA," & cFile & ".desca,[VALUE]," & cFile & ".CODE,FILE3_10.DESCA,[ID] " & _
               " FROM " & cFile & " LEFT JOIN " & DocClient & " ON " & cFile & ".Charge = " & DocClient & ".CODE " & " LEFT JOIN FILE3_10 ON " & cFile & ".CODE = FILE3_10.CODE " & _
...
ElseIf Col = 5 Then
    ...
    Else
        ...
        aRet = GetFields("SELECT CODE,DESCA FROM FILE3_10 WHERE CODE = " & MyParn(grid1.EditText))
        If IsEmpty(aRet) Then
            MsgBox "ﬂÊœ «·⁄„Ì· €Ì— ’ÕÌÕ"
            Cancel = True
        Else
            grid1.TextMatrix(grid1.Row, 6) = retFlag(aRet, "DESCA")
        End If
    End If
End If
End Sub
...
With grid1
    ...
    .FormatString = "Œ“‰…|" & "«·«Ì—«œ|" & "Ê’› «·«Ì—«œ|" & "«·»Ì«‰|" & "«·ﬁÌ„…|" & "«·⁄„Ì·|" & "≈”„ «·⁄„Ì·|"
    .ColWidth(0) = 2000
    .ColWidth(1) = 1000
    .ColWidth(2) = 2900
    .ColWidth(3) = 4000
...
If Col < grid1.Cols - 3 Then
    grid1.Col = Col + 1 + IIf(Col = 1, 1, 0) + IIf(Col = 5, 1, 0)
