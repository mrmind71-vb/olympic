...
Begin VB.Form grdpaid_bg2 
   Caption         =   "ÅÌãÇáí ÈäæÏ ÇíÕÇáÇÊ ÓÏÇÏ ãÑßÒ ÇáÎÏãÇÊ"
   ClientHeight    =   10110
   ClientLeft      =   90
   ClientTop       =   465
   ClientWidth     =   16785
...
PrintGrdNew.doprint grid1, 1, -2, Me.Caption, cHead2, cHead3, , False, False, 10, , aRow
PrintGrdNew.Show 1
End Sub
...
cString = "SELECT FILE6_50.CODE, FILE5_20.DESCA + CASE WHEN ENG = 1 THEN ' ãåäÏÓíä' ELSE ' ÛíÑ ãåäÏÓíä ' END,SUM(QUANT), SUM(FILE6_50.VALUE)" & _
          "  FROM FILE6_50H INNER JOIN FILE6_50 ON FILE6_50H.DOC_NO = FILE6_50.DOC_NO INNER JOIN FILE5_20 ON FILE6_50.CODE = FILE5_20.CODE"
...
End If
cString = cString & " group by FILE6_50.CODE, FILE5_20.DESCA,FILE6_50H.ENG ORDER BY FILE6_50.CODE"
...
Dim nTotal_Sales As Double, nTotal_in As Double
    ...
    .TextMatrix(0, 0) = "ÇáßæÏ"
    .TextMatrix(0, 1) = "ÇáäÔÇØ"
    .TextMatrix(0, 2) = "ÅÌãÇáí ÇáÚÏÏ"
    .TextMatrix(0, 3) = "ÅÌãÇáí ÇáãÓÏÏ"
