...
Begin VB.Form grdpaid_sport3 
   Caption         =   "ÅÌãÇáí ãÌãæÚÇÊ ÈäæÏ äÔÇØ ÕíÝí"
   ClientHeight    =   10110
   ClientLeft      =   90
   ClientTop       =   465
   ClientWidth     =   16785
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.CommandButton cmdGo 
         Height          =   555
         Left            =   3645
         Picture         =   "grdpaid_sport3.frx":0000
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   11
         ToolTipText     =   "ÚÑÖ"
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   555
         Left            =   2415
         Picture         =   "grdpaid_sport3.frx":3059
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   10
         Top             =   135
      ...
      Begin VB.CommandButton cmdExit 
         Height          =   555
         Left            =   45
         Picture         =   "grdpaid_sport3.frx":5483
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   9
         Top             =   135
      ...
      Begin VB.CommandButton cmdExel 
         Height          =   555
         Left            =   1215
         Picture         =   "grdpaid_sport3.frx":78EF
         RightToLeft     =   -1  'True
         Style           =   1  'Graphical
         TabIndex        =   8
         ToolTipText     =   "ÚÑÖ"
   ...
   End
End
Attribute VB_Name = "grdpaid_sport3"
...
cString = "SELECT  FILE1_30G.CODE, FILE1_30G.DESCA, SUM(FILE6_30.QUANT),SUM(FILE6_30.TOTAL)" & _
          "  FROM FILE6_30H INNER JOIN FILE6_30 ON FILE6_30H.DOC_NO = FILE6_30.DOC_NO INNER JOIN FILE1_30 ON FILE6_30.CODE = FILE1_30.CODE INNER JOIN FILE1_30G ON FILE1_30.[GROUP] = FILE1_30G.CODE"
...
cString = cString & " group by FILE1_30G.CODE, FILE1_30G.DESCA ORDER BY FILE1_30G.CODE"
