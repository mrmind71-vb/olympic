...
'                           0               1                 2                3
    cStrAll = "  select file1_10.item , file1_10.desca , FILE1_10.PRICE , FILE1_10.PRICE2 , " & _
                ...
                " from FILE1_11 INNER JOIN FILE1_10 ON FILE1_10.ITEM = FILE1_11.ITEM WHERE TRUE "
    If xGroup.BoundText <> "" Then cStrAll = cStrAll & " AND [GROUP]  = " & xGroup.BoundText
    If xGroupMain.BoundText <> "" Then cStrAll = cStrAll & " AND [GroupMain]  = " & xGroupMain.BoundText
